...
function MobileLineDelegatorCount(){
  ...
  const options = getLineGraphOptionsBuilder({ type: 'spline', title : 'Delegators',titleFontSize: '2rem', xAxisType :'datetime', data: combinedData, seriesName :'Delegator Count', marginLeft: 220, marginRight: 0, marginBottom: 60, titleY: 20, marginTop: 100,subtitleFontSize: '0.8rem',
...
dataLogoX: 0, dataLogoY: 0, dataLogoWidth: 0, dataLogoHeight: 0, height: '40%', width: '55%'});
  ...
  export default MobileLineDelegatorCount;

  export function MobileLineIndexerCount(){
    const { data, requestStatus, error, status} = useGraphDataAPI();
    if(requestStatus === REQUEST_STATUS.LOADING){
      return(
        <div>Loading Chart...</div>
    ...
    //options builder like we have done previously
    const options = getLineGraphOptionsBuilder({ type: 'spline', title : 'Indexers',titleFontSize: '2rem', xAxisType :'datetime', data: combinedData, seriesName :'Indexer Count',marginLeft: 220, marginRight: 0, marginBottom: 60, titleY: 20, marginTop: 100,subtitleFontSize: '0.8rem',
    dataLabelFontSize: '3vh',
    subtitleX: 0,
    subtitleY: 25,
    ...
    export function MobileLineStakedIndexersCount(){
      const { data, requestStatus, error, status} = useGraphDataAPI();
      if(requestStatus === REQUEST_STATUS.LOADING){
        return(
          <div>Loading Chart...</div>
      ...
      //options builder like we have done previously
      const options = getLineGraphOptionsBuilder({ type: 'spline', titleFontSize: '2rem',title : 'Staked Indexers', xAxisType :'datetime', data: combinedData, seriesName :'Staked Indexer Count',marginLeft: 220, marginRight: 0, marginBottom: 60, titleY: 20, marginTop: 100,subtitleFontSize: '0.8rem',
      dataLabelFontSize: '3vh',
      subtitleX: 0,
      subtitleY: 25,
      ...
      export function MobileLineSubgraphCount(){
        const { data, requestStatus, error, status} = useGraphDataAPI();
        if(requestStatus === REQUEST_STATUS.LOADING){
          return(
            <div>Loading Chart...</div>
        ...
        //options builder like we have done previously
        const options = getLineGraphOptionsBuilder({ type: 'spline', title : 'Subgraphs',titleFontSize: '2rem', xAxisType :'datetime', data: combinedData, seriesName :'Subgraph Count',marginLeft: 220, marginRight: 0, marginBottom: 60, titleY: 20, marginTop: 100,subtitleFontSize: '0.8rem',
        dataLabelFontSize: '3vh',
        subtitleX: 0,
        subtitleY: 25,

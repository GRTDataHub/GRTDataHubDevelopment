...
function LandscapeMobileActiveDelegatorCountBar(){
...
export default LandscapeMobileActiveDelegatorCountBar;

export function LandscapeMobileHoldersCountBar(){
  const { data, requestStatus, error } = useBarAPI();
  const [lastMonth, lastWeek, Now] = getDaysInRange(28,7);
...
export function LandscapeMobileSubgraphCountBar(){
  const { data, requestStatus, error } = useBarAPI();
  const [lastMonth, lastWeek, Now] = getDaysInRange(28,7);
...
export function LandscapeMobileCuratorCountBar(){
  const { data, requestStatus, error } = useBarAPI();
  const [lastMonth, lastWeek, Now] = getDaysInRange(28,7);
...
export function LandscapeMobileActiveDelegationCountBar(){
  const { data, requestStatus, error } = useBarAPI();
  const [lastMonth, lastWeek, Now] = getDaysInRange(28,7);
...
export function LandscapeMobileActiveIndexersCountBar(){
  const { data, requestStatus, error } = useBarAPI();
  const [lastMonth, lastWeek, Now] = getDaysInRange(28,7);
...
export function LandscapeMobileTotalDelegatedGRT(){
  const { data, requestStatus, error } = useBarAPI();
  const [lastMonth, lastWeek, Now] = getDaysInRange(28,7);
...
export function LandscapeMobileTotalDelegatedGRTIndexers(){
  const { data, requestStatus, error } = useBarAPI();
  const [lastMonth, lastWeek, Now] = getDaysInRange(28,7);
...
export function LandscapeMobileTotalQueryFees(){
  const { data, requestStatus, error } = useBarAPI();
  const [lastMonth, lastWeek, Now] = getDaysInRange(28,7);
...
export function LandscapeMobileTotalTokensSignalled(){
  const { data, requestStatus, error } = useBarAPI();
  const [lastMonth, lastWeek, Now] = getDaysInRange(28,7);
...
export function LandscapeMobileTotalStakedGRT(){
  const { data, requestStatus, error } = useBarAPI();
  ...
  const options = useColumnGraphOptionsBuilder(
    ...
    subtitleX: 0,
    subtitleY: 30,
    logoX: 0, logoY: 0, logoWidth: 0, logoHeight:0, height: '30%', width: '80%'});
...
export function LandscapeMobileTotalBurnedGRT(){
  const { data, requestStatus, error } = useBarAPI();
  const [lastMonth, lastWeek, Now] = getDaysInRange();

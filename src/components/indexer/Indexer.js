...
<div class="message">
  Please rotate your device to landscape to view the Indexer page.
        ...
        <div className="indexer"><iframe className="map" title="Indexers" src="https://thegraph.stake-machine.com/d-solo/-3BUUtbMz?orgId=1&refresh=5m&from=1649154550894&to=1649240950894&theme=dark&panelId=92" width="900" height="400" frameborder="0"></iframe>

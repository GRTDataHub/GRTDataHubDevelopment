...
import { TotalDelegatedGRT } from "../mainBarCharts/BarChartsData";

class TotalGRTDelegatedByDelegators extends React.Component {
  render() {
  return (
...
<div className="hide-telegram top-telegram"><TotalDelegatedGRT /></div>    
...
export default TotalGRTDelegatedByDelegators;
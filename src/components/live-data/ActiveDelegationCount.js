...
import { ActiveDelegationCountBar } from "../mainBarCharts/BarChartsData";

class ActiveDelegationCount extends React.Component {
  render() {
  return (
...
<div className="hide-telegram top-telegram"><ActiveDelegationCountBar /></div>    
...
export default ActiveDelegationCount;
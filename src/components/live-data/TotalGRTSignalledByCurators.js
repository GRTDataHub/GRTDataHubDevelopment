...
import { TotalTokensSignalled } from "../mainBarCharts/BarChartsData";

class TotalGRTSignalledByCurators extends React.Component {
  render() {
  return (
...
<div className="hide-telegram top-telegram"><TotalTokensSignalled /></div>    
...
export default TotalGRTSignalledByCurators;
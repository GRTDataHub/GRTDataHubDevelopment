...
import { TotalStakedGRT } from "../mainBarCharts/BarChartsData";

class TotalStakedGRTCount extends React.Component {
  render() {
  return (
...
<div className="hide-telegram top-telegram"><TotalStakedGRT /></div>    
...
export default TotalStakedGRTCount;
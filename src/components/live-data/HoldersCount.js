...
import { HoldersCountBar } from "../mainBarCharts/BarChartsData";

class HoldersCount extends React.Component {
  render() {
  return (
...
<div className="hide-telegram top-telegram"><HoldersCountBar /></div>    

...
import { SubgraphCountBar } from "../mainBarCharts/BarChartsData";

class SubgraphCount extends React.Component {
  render() {
  return (
...
<div className="hide-telegram top-telegram"><SubgraphCountBar /></div>    

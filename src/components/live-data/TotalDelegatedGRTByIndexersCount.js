...
import { TotalDelegatedGRTIndexers } from "../mainBarCharts/BarChartsData";

class TotalGRTDelegatedByIndexersCount extends React.Component {
  render() {
  return (
...
<div className="hide-telegram top-telegram"><TotalDelegatedGRTIndexers /></div>    
...
export default TotalGRTDelegatedByIndexersCount;
...
import { CuratorCountBar } from "../mainBarCharts/BarChartsData";

class CuratorsCount extends React.Component {
  render() {
  return (
...
<div className="hide-telegram top-telegram"><CuratorCountBar /></div>    

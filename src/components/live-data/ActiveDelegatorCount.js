...
import ActiveDelegatorCountBar from "../mainBarCharts/BarChartsData";

class ActiveDelegatorCount extends React.Component {
  render() {
  return (
...
<div className="hide-telegram top-telegram"><ActiveDelegatorCountBar /></div>    
...
export default ActiveDelegatorCount;
...
return (
  ...
  <p className="pt-auto footer">
            ...
            Envíe un correo electrónico a <span className="email">admin@GRTDataHub.com</span> para solicitar más datos.<br></br>Si tiene alguna sugerencia de mejora, encuentra fallas o problemas <br></br>con la aplicación, comuníquese a través de <a className="data-link"  href="https://t.me/GraphtronautsDataHub" target="_blank" rel="noreferrer">Telegram</a> o <a className="data-link"  href="https://twitter.com/GRTCrypto" target="_blank" rel="noreferrer">Twitter</a>.<br></br>

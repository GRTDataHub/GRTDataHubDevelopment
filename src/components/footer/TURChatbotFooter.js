...
return (
  ...
  <p className="pt-auto footer">
            ...
            Daha fazla veri istemek için lütfen <span className="email">admin@GRTDataHub.com</span> adresine e-posta gönderin.<br></br>Önerilen herhangi bir iyileştirmeniz varsa, uygulamayla ilgili aksaklıkları veya sorunları bulun, <br></br>ardından lütfen Telegram Twitter <a className="data-link"  href="https://t.me/GRTDataHub" target="_blank" rel="noreferrer">Telegram</a> veya  <a className="data-link"  href="https://twitter.com/GRTCrypto" target="_blank" rel="noreferrer">Twitter</a> aracılığıyla iletişime geçin.<br></br>

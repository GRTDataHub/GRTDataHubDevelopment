...
return (
  ...
  <div className="col-auto">
            ...
            Please email <span className="email">admin@GRTDataHub.com</span> to request more data. <br></br>If you have any suggested improvements, find glitches or issues with the app <br></br>then please get in touch via <a className="data-link"  href="https://t.me/GraphtronautsDataHub" target="_blank" rel="noreferrer">Telegram</a> or <a className="data-link"  href="https://twitter.com/GRTCrypto" target="_blank" rel="noreferrer">Twitter</a>.<br></br>

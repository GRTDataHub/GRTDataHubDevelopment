...
handleGRTTokenAddress() {
  const message = this.createChatbotMessage(<a>Adresse du jeton GRT: 0xc944e90c64b2c07662a292be6244bdf05cda44a7</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,

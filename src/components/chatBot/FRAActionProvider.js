...
handleActiveDelegatorCount() {
  ...
  <a className="cla" href="https://grtdatahub.com/ActiveDelegatorCount" target="_blank" rel="noreferrer">Click here</a> to view Active Delegator Count in full view.</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleActiveDelegationCount() {
  ...
  <a className="cla" href="https://grtdatahub.com/ActiveDelegationCount" target="_blank" rel="noreferrer">Click here</a> to view Active Delegation Count in full view.</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleHoldersCount() {
  ...
  <a className="cla" href="https://grtdatahub.com/HoldersCount" target="_blank" rel="noreferrer">Click here</a> to view Holders Count in full view.</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleSubgraphsCount() {
  ...
  <a className="cla" href="https://grtdatahub.com/SubgraphsCount" target="_blank" rel="noreferrer">Click here</a> to view Subgraph Count in full view.</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleCuratorsCount() {
  ...
  <a className="cla" href="https://grtdatahub.com/CuratorsCount" target="_blank" rel="noreferrer">Click here</a> to view Curator Count in full view.</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleActiveIndexerCount() {
  ...
  <a className="cla" href="https://grtdatahub.com/ActiveIndexerCount" target="_blank" rel="noreferrer">Click here</a> to view Active Indexer Count in full view.</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleTotalGRTDelegatedByDelegators() {
  ...
  <a className="cla" href="https://grtdatahub.com/TotalGRTDelegatedByDelegators" target="_blank" rel="noreferrer">Click here</a> to view Total amount of GRT Delegated by Delegators in full view.</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleTotalQueryFeesCount() {
  ...
  <a className="cla" href="https://grtdatahub.com/TotalQueryFeesCount" target="_blank" rel="noreferrer">Click here</a> to view Total Query Fees Count in full view.</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleTotalGRTSignalledByCurators() {
  ...
  <a className="cla" href="https://grtdatahub.com/TotalGRTSignalledByCurators" target="_blank" rel="noreferrer">Click here</a> to view Total Amount of GRT Signalled by Curators in full view.</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleTotalStakedGRTCount() {
  ...
  <a className="cla" href="https://grtdatahub.com/TotalStakedGRTCount" target="_blank" rel="noreferrer">Click here</a> to view Total Amount of GRT Staked in full view.</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleTotalDelegatedGRTByIndexersCount() {
  ...
  <a className="cla" href="https://grtdatahub.com/TotalDelegatedGRTByIndexersCount" target="_blank" rel="noreferrer">Click here</a> to view Total Amount of Delegated GRT by Indexers in full view.</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleTotalGRTBurnedCount() {
  ...
  <a className="cla" href="https://grtdatahub.com/TotalGRTBurnedCount" target="_blank" rel="noreferrer">Click here</a> to view Total Amount of GRT Burned in full view.</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleChoosingIndexers() {
  ...
  const message = this.createChatbotMessage(<a>It can be a tough decision choosing an indexer to delegate to. The following information and resources will help you. Just because an Indexer has the highest APY does not mean they are the best for you. Do your own research, take your time and learn what to look for when choosing an Indexer to delegate to. This will ensure you are confident before delegating.<hr></hr>Reading this Graphtronauts guide on <a className="cla" href="https://medium.com/@OG-Graphtronauts/how-to-chose-an-indexer-for-delegation-in-graph-protocol-a59725c16062" target="_blank">How to Choose an Indexer for Delegation in The Graph Protocol</a> and watching the <a className="cla" href="https://www.youtube.com/watch?v=oQijzTv7EQQ" target="_blank">Choosing Indexers</a> tutorial will help you understand what you need to be looking for.<br></br><br></br>The <a className="cla" href="https://www.graphtronauts.com/#/indexers" target="_blank" rel="noreferrer">Graphtronauts app</a> allows delegators to gain useful insights on the Indexer of their choice. Simply insert the ETH address of the Indexer of your choice or have a look at the reviews. You can also Compare Indexers within the app.<br></br><br></br>Once you are ready to Delegate, please <a className="cla" onClick={this.handleDelegateGuides}><strong>click me</strong></a> and I will provide you with text and video tutorials.</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleJob() {
  const message = this.createChatbotMessage(<a>Want to work in web3? Good news, The Graph ecosystem is hiring! There are opportunities across The Graph Foundation and the core dev teams. Take a look <a className="cla" href="https://thegraph.com/jobs/#open-positions" target="_blank" rel="noreferrer">here</a> for current open positions.</a>
    ,
  );
...
handleRoles() {
  ...
  const message = this.createChatbotMessage(<a>
    The Graph Network consists of three roles that provide services to the ecosystem and serve data to Web3 applications such as Uniswap, Aave and Synthetix: Indexers, Curators and Delegators. You can find detailed documentation for each of the roles below.<br></br><a className="cla" onClick={this.handleBecomeIndexer}><strong>Indexers</strong></a><br></br><a className="cla" onClick={this.handleCurator}><strong>Curators</strong></a><br></br><a className="cla" onClick={this.handleDelegateGuides}><strong>Delegators</strong></a><br></br><br></br>To ensure economic security of The Graph Network and the integrity of data being queried, participants stake and use Graph Tokens (GRT). GRT is a work token that is an ERC-20 on the Ethereum blockchain, used to allocate resources in the network. Active Indexers, Curators and Delegators can provide services and earn income from the network, proportional to the amount of work they perform and their GRT stake.</a>
    ,
  );
...
handleTheGraphFoundation() {
  const message = this.createChatbotMessage(<a>
    The creation of The Graph Foundation was <a className="cla" href="https://thegraph.com/blog/announcing-the-graph-foundation" target="_blank" rel="noreferrer">announced</a> in October 2020. <a className="cla" href="https://ca.linkedin.com/in/evabeylin?original_referer=https%3A%2F%2Fdocs.thegraph.academy%2Fthe-graph-ecosystem%2Forganizational-structure%2Fthe-graph-foundation" target="_blank" rel="noreferrer">Eva Beylin</a> serves as Director of The Graph Foundation. Responsible for stewarding the protocol, The Graph Foundation will provide coordination and support to the ecosystem. The establishment of the foundation was part of the strategy to create an independent organizational structure that is decentralized.<hr></hr>Council Members:<br></br>Indexers<br></br>Jim Cousins & Gary Morris<br></br>Users<br></br>Justin J Moses & Kayvon Tehranian<br></br>Researchers<br></br>Santiago Palladino & Yondon Fu<br></br>Backers<br></br>Michael Anderson & Spencer Noon<br></br>Initial Team<br></br>Brandon Ramirez & Yaniv Tal</a>
    ,
  );
...
handleTheGraphCouncil() {
  const message = this.createChatbotMessage(<a>
    The Graph Council was <a className="cla" href="https://thegraph.com/blog/introducing-the-graph-council" target="_blank" rel="noreferrer">introduced</a> in October 2020 as a part of the plans to decentralize the protocol. The <a className="cla" href="https://thegraph.com/blog/inaugurating-council-and-grants" target="_blank" rel="noreferrer">members of The Graph Council</a> were inaugurated in December 2020. The Graph Council governs the decentralized Graph Network. A 6-of-10 multisig balances the interests of five different stakeholder groups in the ecosystem: Indexers, token holders, initial team, users and technical domain experts.<br></br><br></br>The mandate of The Graph Council includes the following core functions:<br></br>The Graph Foundation Operations<br></br>Grants and Ecosystem Funding<br></br>Protocol Upgrades<br></br>Protocol Parameterization<br></br>Emergency Protocol Operations<br></br><br></br>In the future, it is planned to further decentralize The Graph's governance, for instance by replacing individual members with nested multisigs or DAOs.</a>
    ,
  );
...
handleBecomeIndexer() {
  const message = this.createChatbotMessage(<a><strong>How to Become an Effective Indexer on The Graph Network</strong><hr></hr>Minimum Requirements for Indexers - There are four main requirements needed to be an effective Indexer on The Graph Network.<br></br><br></br><strong>Stake</strong> - You must stake at least 100,000 GRT to be an Indexer.<br></br><br></br><strong>Skills</strong> - Ideally, Indexers should have a background in DevOps or experience operating blockchain nodes. Indexers should be comfortable deploying cloud or hosted servers, or running their own server hardware. Familiarity with running a validator node and working on Linux is also suggested.<br></br><br></br><strong>Hardware</strong> - In order to balance efficiency, query output, and speed, many Indexers often start with a setup of 16 CPUs, a 1 TB disk, and 32 GB of RAM.<br></br><br></br><strong>Infrastructure Software</strong> - Familiarity with container and scaling technologies such as Docker and Kubernetes is advantageous, however it is also possible to deploy the Graph software to bare metal. Infrastructure software requirements include a PostgreSQL database, Graph Node, Indexer agent, Indexer service, Prometheus metrics server, and potentially more depending on your specific requirements and setup.<br></br><br></br>To learn about the best practices for Indexers on The Graph Network, ideal Indexer community participation, a recommended Indexer tech setup, resources and guides and start start your <strong>indexing journey</strong> with The Graph.<br></br><br></br>This <a className="cla" href="https://thegraph.com/blog/how-to-become-indexer/" target="_blank" rel="noreferrer">guide</a> helps you learn the operational requirements, best practices, and communication tactics to become a best-in-class Indexer on The Graph Network.</a>
    ,
  );
...
handleGraphDiscord() {
  const message = this.createChatbotMessage(<a>The Graph Offical Discord Server can be found <a className="cla" href="https://discord.com/invite/vtvv7FP" target="_blank" rel="noreferrer">here</a></a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
// Rewards Start 
handleRewards() {
  const message = this.createChatbotMessage(<a>Indexing rewards are collected and distributed whenever Indexers close their allocations. While they are active, allocations keep accruing rewards continuously. Indexers can either force close their allocations manually or let them be closed automatically after the maximum allocation lifetime (every 28 epochs).<br></br><br></br>1 epoch = ~24 hours<br></br><br></br>Allocations are continuously accruing rewards while they're active. Rewards are collected by the indexers, and distributed whenever their allocations are closed. That happens either manually, whenever the indexer wants to force close them, or automatically every maximum 28 epochs - max allocation lifetime (right now, one epoch lasts for ~24h).<hr></hr>To see your pending rewards, visit <a className="cla" href="https://www.graphtronauts.com/#/profile" target="_blank" rel="noreferrer">Graphtronauts</a> app and add a wallet.</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleQueryFees() {
  const message = this.createChatbotMessage(<a>Whenever an allocation is closed (either manually by an Indexer or automatically after the maximum allocation lifetime), query fees are collected by the protocol's gateway. The query fees are accumulated in the subgraph's query fee rebate pool. The distributed amount of query fees from the rebate pool is calculated based on Indexer's contributions to the rebate pool and their allocated stake on the subgraph.<br></br><br></br>After an allocation has been closed, query fees can only be claimed by Indexers after the dispute period has passed. Once an Indexer successfully claims the query fees, rebates are distributed to the Indexer and their Delegators.<br></br><br></br>Following the <a className="cla" href="https://en.wikipedia.org/wiki/Cobb%E2%80%93Douglas_production_function" target="_blank" rel="noreferrer">Cobb-Douglas Production Function</a>, a Rebate Pool is created that rewards all network participants (like Indexers) based on their contributions to The Graph Network. The intention behind the Rebate Pool is to encourage Indexers to stake GRT in rough proportion to the amount of query fees they earn for the network. The Rebate Pool receives a fixed portion of query fees that are contributed to it.</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleIndexingRewardsAndQueryFees() {
  const message = this.createChatbotMessage(<a>Indexing rewards are distributed across subgraphs in proportion to the subgraph's curation signal. Indexers receive their indexing rewards proportional to the stake they have allocated on a particular subgraph.<br></br><br></br>Indexing rewards are generated by protocol inflation which is set to 3% annual issuance.<br></br><br></br>All allocations need to be closed with a valid proof of indexing (POI).</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handlePOI() {
  const message = this.createChatbotMessage(<a>The so-called proof of indexing (POI) verifies that Indexers have factually indexed the subgraphs they have allocated their stake on. The POI for a block is a digest for all entity store transactions detailing deployment on a subgraph. In order to receive indexing rewards, Indexers have to close an allocation with a valid proof of indexing (POI) that meets the standards set by the arbitration charter. Indexers are not eligible for rewards without a valid POI. When closing an allocation, a POI for the first block of the current epoch must be submitted by the Indexer.<br></br><br></br>Indexing rewards are collected and distributed whenever Indexers close their allocations. While they are active, allocations keep accruing rewards continuously. Indexers can either force close their allocations manually or let them be closed automatically after the maximum allocation lifetime (every 28 epochs).<br></br><br></br>1 epoch = ~24 hours</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleIndexerHardwareRequirements() {
  const message = this.createChatbotMessage(<a>The hardware requirements to participate in the network as an Indexer can be found in the table below.<hr></hr><table><tr className="indexer-table-header">
    <th>Setup</th>
    <th>Postgres (CPUs)</th>
...
<br></br><br></br>Small = enough to get started with indexing several subgraphs<br></br>Standard = default setup<br></br>Medium = required for indexing 100 subgraphs and performing 200-500 requests per second<br></br>Large = Required for indexing all currently used subgraphs and serving requests for the related traffic
 </a>
    ,
  );
  this.setState((prev) => ({
...
// Allocations Start
handleAllocations() {
  const message = this.createChatbotMessage(<a>Allocations are continuously accruing rewards while they're active. Rewards are collected by the indexers, and distributed whenever their allocations are closed. That happens either manually, whenever the indexer wants to force close them, or automatically every maximum 28 epochs - max allocation lifetime (right now, one epoch lasts for ~24h).</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
// IPFS Start
handleIPFS() {
  const message = this.createChatbotMessage(<a>Documentation for Indexers how to get subgraph's ipfs hash from id and vise versa can be found <a className="cla" href="https://docs.thegraph.academy/network/indexers/technical-documentation/get-ipfs-hash-from-deployment-id" target="_blank" rel="noreferrer">here</a>.</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleFeesToDelegate() {
  const message = this.createChatbotMessage(<a>Every time you delegate GRT to an Indexer, you need to take a <strong>0.5% delegation fee</strong> into account. For example, if you delegate 10,000 GRT, you will be charged 50 GRT. If your chosen Indexer offers you an earnings potential of 2 GRT per day. Under this assumption, it would take you 25 days (50 GRT / 2 GRT) to break even. To make economically sound decisions, you have to calculate how long it takes you to earn back the 0.5% tax on your delegation.<br></br><br></br>Delegating to an Indexer will require you to sign <strong>two ETH transactions</strong>. The same holds true for undelegating your GRT. In case of high gas prices, you will have to calculate carefully whether or not it is economically sound to delegate small amounts of GRT.<br></br>For example, let us assume that signing two ETH transactions will cost you $25. Let us also assume that you only want to delegate $100. In this case, the transaction costs of delegating would make up a total of 25% of your GRT stack. This means that the time until you break even would be significantly increased.<br></br><br></br>If Delegators wish to undelegate, they cannot immediately access their tokens. Undelegated tokens are subject to a 28 day thawing period, only then Delegators can freely transfer their tokens or re-delegate them to another Indexer.<br></br><br></br>Choosing a reputable, trustworthy and effective Indexer is an important decision that should not be taken lightly. Delegators who do not do their due diligence face the risk of delegating to an Indexer with a poor performance. Similarly, they may risk choosing an Indexer who engages in dubious practices or subsidises Delegators for a short time to advertise an attractive APY (Annual Percentage Yield) that is not realistic in the long run.<br></br><br></br>Documentation on the risks of being a Delegator can be found, <a className="cla" href="https://thegraph.academy/delegators/risks/" target="_blank">here</a>.<br></br><br></br><a className="cla" href="https://medium.com/@OG-Graphtronauts/how-to-reduce-the-cost-of-gas-for-delegating-your-grt-tokens-8b2edb3697c5" target="_blank" rel="noreferrer">How to reduce the cost of gas for delegating your GRT tokens</a><br></br><br></br>For the average cost of a delegation transaction at this time, visit the <a className="cla" href="https://www.graphtronauts.com/#/indexers" target="_blank" rel="noreferrer">Graphtronauts</a> app and select Fees.</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleQueryPython() {
  const message = this.createChatbotMessage(<a><strong>How to Query The Graph Protocol for On-Chain Data using Python</strong><br></br><br></br><a className="cla" href="https://hashnode.com/@townee" target="_blank">Tony Kipkemboi</a> has wrote an amazing step-by-step guide on querying Subgraphs using <strong>Python</strong>, GraphQL, and Subgrounds.<br></br><br></br>The full blog can be found <a className="cla" href="https://townee.hashnode.dev/how-to-query-the-graph-protocol-for-on-chain-data-using-python" target="_blank">here</a>.<br></br><br></br>You can follow <a className="cla" href="https://twitter.com/ynot_kip" target="_blank">Tony</a> on Twitter to be updated when his second blog is released to the community, "How do I use subgrounds when the Hosted Service is sunsetted?".</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleWeb3DApp() {
  const message = this.createChatbotMessage(<a>How Web3 dApps works?<br></br><br></br>You can find "A complete guide to Web3 Architecture" <a className="cla" href="https://twitter.com/suhailkakar/status/1555894207570513920?s=21&t=FoLxHgWLO78VA_3VheV_DQ" target="_blank">here</a> in an extremely helpful Twitter thread.</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleSoulBound() {
  const message = this.createChatbotMessage(<a>Building dApps shouldn't be painful.<br></br><strong><a className="cla" href="https://soulbound.xyz/" target="_blank">Soulbound Studio</a></strong> makes it easy.<br></br>No coding required.<br></br><br></br>One unified interface for designing, iterating, and publishing fully decentralized Web3 APIs and frontends.<br></br><br></br>If you want to help them design Soulbound Studio by sharing your desired features and bug reports then please join their <a className="cla" href="https://discord.com/invite/Eu3Eeh4J6a" target="_blank">Discord</a>.<br></br><br></br>To keep up to date with their latest releases and news, follow Soulbound Labs on <a className="cla" href="https://twitter.com/SoulboundLabs" target="_blank">Twitter</a>.<br></br><br></br>For a video tutorial on how you can Build Subgraphs dApps and Analytics in Minutes using Soulbound Studio with no coding at all, watch below.<br></br><br></br>
...
handleIPhone() {
  const message = this.createChatbotMessage(<a>Don’t keep big money and Bored Apes on your phone in a hot wallet! Because your iPhone is probably syncing your MetaMask info to iCloud. It’s on by default, <a className="cla" href="https://twitter.com/plumferno/status/1556187973200351234?s=21&t=a-4X_QM7BzHRKcJe8aPc_w" target="_blank">here</a> is an extremely helpful Twitter thread on how to turn that off!</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleQueryFeesAndIndexingRewardCut() {
  const message = this.createChatbotMessage(<a>The queryFeeCut and indexingRewardCut values are delegation parameters that the Indexer may set along with cooldownBlocks to control the distribution of GRT between the indexer and their delegators. See the last steps in Staking in the Protocol for instructions on setting the delegation parameters.<br></br><br></br>queryFeeCut - the % of query fee rebates accumulated on a subgraph that will be distributed to the indexer. If this is set to 95%, the indexer will receive 95% of the query fee rebate pool when an allocation is claimed with the other 5% going to the delegators.<br></br><br></br>indexingRewardCut - the % of indexing rewards accumulated on a subgraph that will be distributed to the indexer. If this is set to 95%, the indexer will receive 95% of the indexing rewards pool when an allocation is closed and the delegators will split the other 5%.</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
// Graph Funding Start
handleGraphFunding() {
  const message = this.createChatbotMessage(<a>According to <a className="cla" href="https://www.crunchbase.com/organization/the-graph/investor_financials" target="_blank" rel="noreferrer">Crunchbase.com</a>, The Graph has raised a total of $69.6M in funding over 7 rounds. Their latest funding was raised on Jan 21, 2022 from a Venture - Series Unknown round.<br></br><br></br>The Graph is funded by 27 investors. Blockwall Management and FinTech Collective are the most recent investors.<br></br><br></br>The Graph has raised a total of $205M in a single venture fund, The Graph Ecosystem Fund. This fund was announced on Feb 18, 2022 and raised a total of $205M.</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleWhatIsTheGraph() {
  const message = this.createChatbotMessage(<a>The Graph $GRT is an indexing protocol for querying networks like Ethereum and IPFS. Anyone can build and publish open APIs, called subgraphs, making data easily accessible. In short, The Graph provides data that can be transformed, organized, and shared across applications for anyone to query with just a few keystrokes.<br></br><br></br><a className="cla" href="https://thegraph.com/ecosystem/governance/" target="_blank" rel="noreferrer">How The Graph is Governed</a><br></br><a className="cla" href="https://thegraph.com/ecosystem/governance/#graph-council" target="_blank" rel="noreferrer">The Graph Council</a><br></br><a className="cla" href="https://thegraph.com/ecosystem/governance/#graph-foundation" target="_blank" rel="noreferrer">The Graph Foundation</a><br></br><a className="cla" href="https://thegraph.com/ecosystem/governance/#advocates-dao" target="_blank" rel="noreferrer">Graph Advocates­DAO</a><br></br><br></br>You can read 'The Graph history (2017–2020)' made by the Graphtronauts, <a className="cla" href="https://blog.graphtronauts.com/the-graph-history-2017-2020-75cc40132992" target="_blank" rel="noreferrer">here</a>.<br></br><br></br>You can read 'What is The Graph and why is it the next big thing in the technology industry' made by the Graphtronauts, <a className="cla" href="https://blog.graphtronauts.com/what-is-the-graph-and-why-is-the-next-big-thing-in-the-technology-industry-25051fae4256" target="_blank" rel="noreferrer">here</a>.<br></br><br></br>For a video explanation of what the 'google of blockchains' is, see <a className="cla" href="https://youtu.be/7gC7xJ_98r8" target="_blank" rel="noreferrer">here</a>.</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
// Airdrop Start
handleAirdrop() {
  const message = this.createChatbotMessage(<a>Regarding airdrops, The Graph is one of very few projects that actually made people work for their tokens. The curator program was very intensive and people spent significant time learning about subgraphs, organizing data, and contributing to the network. This puts the team in an incredible position of having a well trained and incentivized community of builders dedication to growing Web3 on The Graph. At this point in time, there are no airdrops planned.</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
// Free  Start
handleFreeGRT() {
  const message = this.createChatbotMessage(<a><a className="cla" href="https://twitter.com/CoinMarketCap/status/1341310792461918210" target="_blank" rel="noreferrer">CoinMarketCap Earn</a> and <a className="cla" href="https://twitter.com/coinbase/status/1339723594566406156?s=20" target="_blank" rel="noreferrer">Coinbase Earn</a> are giving away free GRT tokens for participants that learn about the network and answer questions.<hr></hr>Psst! The best way to earn free GRT is by delegating and earning rewards.</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
// GitHub Start
handleGitHub() {
  const message = this.createChatbotMessage(<a>You can find The Graph Github address here: <a className="cla" href="https://github.com/graphprotocol/" target="_blank" rel="noreferrer">github.com/graphprotocol/</a></a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
// Road Map Start
handleRoadMap() {
  const message = this.createChatbotMessage(<a>The Graph Official R&D Roadmap can be found <a className="cla" href="https://thegraph.com/blog/roadmap-2022" target="_blank" rel="noreferrer">here</a>.<br></br><br></br><strong>The Graph Roadmap for 2023</strong> written by The Graphtronauts can be found <a className="cla" href="https://medium.com/@OG-Graphtronauts/the-graph-roadmap-for-2023-952b17d20d71" target="_blank" rel="noreferrer">here</a>.<br></br><br></br>In this article you will learn four areas of development that will see the light of day in 2023 and make The Graph network even stronger than it is today:<br></br>The Sunset of the Hosted Service<br></br>Firehose<br></br>Substreams<br></br>Moving the protocol to L2 with Arbitrum One</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
// Schema Start
handleWhatIsSchema() {
  const message = this.createChatbotMessage(<a>The graph uses GraphQL, an open source query language developed by Facebook. Each element in the schema has a description. Learn GraphQL and you can then retrieve all the data that you want from the blockchain.<hr></hr>GraphQL is a query language and server-side runtime for application programming interfaces (APIs) that prioritizes giving clients exactly the data they request and no more. GraphQL is designed to make APIs fast, flexible, and developer-friendly. GraphQL API is the API developers can use to access the indexed data by The Graph.</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
// Buy Start
handleBuy() {
  const message = this.createChatbotMessage(<a>You can see the price and all open markets on <a className="cla" href="https://coinmarketcap.com/currencies/the-graph/markets/" target="_blank" rel="noreferrer">CoinMarketCap</a>.</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleDecentralisedData() {
  const message = this.createChatbotMessage(<a><strong>The Sunrise of Decentralized Data</strong><br></br><br></br>The Graph ecosystem is taking steps to deliver on user expectations while also welcoming the vibrant, decentralized future. To achieve this balance, the discontinuation of hosted service support is divided into three transitional phases on a per-chain basis that are dependent on various exit criteria—including but not limited to usability, stability, and core functionality.<br></br><br></br>Hosted service chains will transition gradually, permitting developers adequate time to familiarize themselves with the decentralized network and migrate their subgraphs.<br></br><br></br>In order to better support developers, specific dates will not be assigned for each phase in transitioning chains from the hosted service and onto The Graph Network. Addressing developer needs and achieving key exit criteria supersede ending hosted service support. As exit criteria are reached per hosted service chain, that chain will transition in three phases. Look to the progress of the MIPs program to understand when chains are being tested by Indexers, when they become supported on the network and when migrations have begun per chain.<br></br><br></br>For each hosted service chain, the three transitional phases in enabling support on The Graph Network are:<br></br>Phase 1 (The Sunray): Disable new hosted service subgraph creation for blockchains that have sufficient core functionality on the network.<br></br>Phase 2 (The Sunbeam): Disable hosted service subgraph upgrades.<br></br>Phase 3 (The Sunrise): Disable querying of hosted service subgraphs.</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleVsSelfHosting() {
  const message = this.createChatbotMessage(<a><strong>The Graph Network vs. Self Hosting</strong><br></br><br></br><underline>Spoiler Alert:</underline> The Graph Network is less expensive, easier to use, and produces superior results compared to running a graph node locally.<br></br><br></br>The Graph’s decentralized network has been engineered and refined to create a robust indexing and querying experience—and it’s getting better every day thanks to thousands of contributors around the world. The benefits of this decentralized protocol cannot be replicated by running a graph node locally. The Graph Network is more reliable, more efficient, and less expensive. Here is an analysis:<br></br><br></br><strong>Why You Should Use The Graph Network</strong><br></br>60-98% lower monthly cost<br></br>$0 infrastructure setup costs<br></br>Superior uptime<br></br>Access to 168 Indexers (and counting)<br></br>24/7 technical support by global community<br></br><br></br>To read a breakdown down og the benefits of using The Graph Network, read <a className="cla" href="https://thegraph.com/docs/en/network/benefits/#breaking-down-the-benefits-of-using-the-graph-network" target="_blank" rel="noreferrer">here</a>.<br></br><br></br><strong>No Setup Costs & Greater Operational Efficiency</strong>Zero setup fees.<br></br>Get started immediately with no setup or overhead costs.<br></br>No hardware requirements.<br></br>No outages due to centralized infrastructure, and more time to concentrate on your core product.<br></br>No need for backup servers, troubleshooting, or expensive engineering resources.<br></br><br></br><strong>Reliability & Resiliency</strong>The Graph’s decentralized network gives users access to geographic redundancy that does not exist when self-hosting a graph node. Queries are served reliably thanks to 99.9%+ uptime, achieved by 168 Indexers (and counting) securing the network globally.</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
// Subgraph Start
handleSubgraph() {
   const message = this.createChatbotMessage(<a>Subgraphs are data structures to organize data that you pull from a blockchain. They are a way to define which data you want to get indexed and how to store it. Some of them do pre-aggregations or calculations on their mappings, some just store plain data similar to what you could find on-chain. Then, an entity queries that data. This entity could be a dapp (company/developer, etc), or could be a telegram bot, or a discord bot or even a simple user doing a query to find information.<br></br><br></br>Querying subgraphs from the hosted service is currently free to use for everyone. For the decentralized protocol, the team expects the query costs to be somewhere around $0.00001 per query, but it’s a free market, and every indexer can set its own cost models.<br></br><br></br>A developer’s cheat sheet for getting up to speed with subgraphs in 15 minutes can be found, <a className="cla" href="https://drive.google.com/file/d/1J2zm06wZV0EwMEGBD48fGbaFKPPcCdZT/view" target="_blank" rel="noreferrer">here</a>.<br></br><br></br>A tutorial for Building a Subgraph with the Subgraph Studio can be found <a className="cla" href="https://www.youtube.com/watch?v=HfDgC2oNnwo" target="_blank" rel="noreferrer">here</a>.<br></br><br></br>For an overview and step-by-step guide on building a subgraph made by <a className="cla" href="https://hashnode.com/@camiinthisthang" target="_blank" rel="noreferrer">Camila Ramos</a>, see <a className="cla" href="https://camiinthisthang.hashnode.dev/the-complete-guide-to-getting-started-with-the-graph" target="_blank" rel="noreferrer">here</a>.<br></br><br></br>If you are looking for a subgraph or would like to explore the ones that have been migrated to mainnet, visit the <a className="cla" href="https://www.graphtronauts.com/#/subgraphs" target="_blank" rel="noreferrer">Graphtronauts</a> app.<br></br><br></br>You can also enroll on the <a className="cla" href="https://thegraph.academy/course/subgraph-developer-course/" target="_blank" rel="noreferrer">Subgraph Developer Course</a>.</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleGRTTokenAddress() {
  const message = this.createChatbotMessage(<a>GRT Token Address: 0xc944e90c64b2c07662a292be6244bdf05cda44a7</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
// Telegram Start
handleTelegram() {
  const message = this.createChatbotMessage(<a>Below you will find the <strong>Official</strong> Telegram group.<br></br><br></br><a className="cla" href="https://t.me/graphprotocol" target="_blank" rel="noreferrer">The Graph Official Community</a><hr></hr>Below you will find the <strong>Un-official</strong> Telegram groups from all over the world.<br></br><br></br><a className="cla" href="https://t.me/graphtronauts" target="_blank">Graphtronauts</a><br></br><a className="cla" href="https://t.me/TheGraph_Germany" target="_blank">The Graph - Germany</a><br></br><a className="cla" href="https://t.me/thegraphfrenchchannel" target="_blank">The Graph - French</a><br></br><a className="cla" href="https://t.me/thegraphenespanol" target="_blank">The Graph - Español</a><br></br><a className="cla" href="https://t.me/thegraphRu" target="_blank">The Graph - Russia</a><br></br><a className="cla" href="https://t.me/thegraphitalia" target="_blank" rel="noreferrer">The Graph - Italia</a><br></br><a className="cla" href="https://t.me/graphprotocolTR" target="_blank" rel="noreferrer">The Graph - Turkey</a><br></br><a className="cla" href="https://t.me/TheGraphBR" target="_blank" rel="noreferrer">The Graph - Brasil</a><br></br><a className="cla" href="https://t.me/GraphProtocol_VN" target="_blank" rel="noreferrer">The Graph - Vietnam</a><br></br><a className="cla" href="https://t.me/Graph_Persian" target="_blank" rel="noreferrer">The Graph - Persian</a><br></br><a className="cla" href="https://t.me/IndianGraphCommunity" target="_blank" rel="noreferrer">The Graph - Indian</a><br></br><a className="cla" href="https://t.me/thegraphjapan" target="_blank" rel="noreferrer">The Graph - Japan</a><br></br><a className="cla" href="https://t.me/TheGraph_Dutch" target="_blank" rel="noreferrer">The Graph - Dutch</a><br></br><a className="cla" href="https://t.me/GRTARAB" target="_blank" rel="noreferrer">The Graph - Arab</a><br></br><a className="cla" href="https://t.me/Thegraph_KR" target="_blank" rel="noreferrer">The Graph - Korea</a><br></br><a className="cla" href="https://t.me/thegraphpk" target="_blank" rel="noreferrer">The Graph - Pakistan</a><br></br><a className="cla" href="https://t.me/graphindonesia" target="_blank" rel="noreferrer">The Graph - Indonesia</a><br></br><a className="cla" href="https://t.me/thegraphbangladesh" target="_blank">The Graph - Bangladesh</a><br></br><a className="cla" href="https://t.me/GraphProtocolCN" target="_blank">The Graph - China</a></a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleBirthday() {
    const message = this.createChatbotMessage(<a><strong>The Graph is turning 2 on December 17th 2022!</strong><br></br><br></br>Help celebrate The Graph Network's launch on mainnet and commitment to decentralization by attending one of the following six community-led birthday events:<br></br><br></br><a className="cla" href="https://www.eventbrite.com/e/the-graph-2-year-birthday-celebration-amsterdam-tickets-471573327517" target="_blank" rel="noreferrer">Amsterdam</a><br></br><br></br><a className="cla" href="https://www.eventbrite.com/e/the-graph-celebracion-del-segundo-cumpleanos-en-buenos-aires-tickets-471157764557" target="_blank" rel="noreferrer">Buenos Aires</a><br></br><br></br><a className="cla" href="https://lu.ma/GraphBdayDubai" target="_blank" rel="noreferrer">Dubai</a><br></br><br></br><a className="cla" href="https://www.eventbrite.com/e/the-graph-2-year-birthday-celebration-lagos-tickets-469718549827" target="_blank" rel="noreferrer">Lagos</a><br></br><br></br><a className="cla" href="https://www.eventbrite.com/e/the-graph-2-year-birthday-celebration-san-francisco-tickets-469624759297" target="_blank" rel="noreferrer">San Francisco</a><br></br><br></br><a className="cla" href="https://www.eventbrite.sg/e/the-graph-2-year-birthday-celebration-singapore-tickets-469791167027" target="_blank" rel="noreferrer">Singapore</a><br></br><br></br>Can’t make it to one of the in-person events? Be sure to join the community on The Graph Twitter for a special birthday Twitter Spaces on Thursday, December 15th at 9:00 am PST. During this special online event, you will hear from core developers and other leaders in the ecosystem - set a reminder to attend on <a className="cla" href="https://twitter.com/i/spaces/1vOGwMQpzPgxB" target="_blank" rel="noreferrer">Twitter.</a></a>
      ,
    );
    this.setState((prev) => ({
      ...prev,
...
noAnswer() {
  ...
  this.handleButtonCoreDevs = this.handleButtonCoreDevs.bind(this);
  this.handleButtonNews = this.handleButtonNews.bind(this);
  const message = this.createChatbotMessage(<a>Sorry, I could not find the answer. Can you try again or rephrase the question? You can always check the <a className="cla" href="/QuestionBank" target="_blank" rel="noreferrer">bank of questions</a>. If I still cannot help you, then please take 2 minutes to fill in the feedback form below. With your help, this will improve my knowledge and enable me to help other GRT community members in the future who may also have the same questions and seeking the answers. Thank you!

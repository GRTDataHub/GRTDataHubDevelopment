...
handleCuratorsCount() {
  ...
  <a className="cla" href="https://grtdatahub.com/CuratorsCount" target="_blank" rel="noreferrer">Haz clic aquí</a> para ver el recuento de Curadores en vista completa.</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleTotalGRTSignalledByCurators() {
  ...
  <a className="cla" href="https://grtdatahub.com/TotalGRTSignalledByCurators" target="_blank" rel="noreferrer">Haz clic aquí</a> para ver la cantidad total de GRT señalada por los Curadores en vista completa.</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleRoles() {
  const message = this.createChatbotMessage(<a>
   Graph Network consta de tres roles que proveen servicios al ecosistema y brindan datos a aplicaciones Web3 como Uniswap, Aave y Synthetix: Indexadores, Curadores y Delegadores. Puedess encontrar documentación detallada para cada uno de los roles a continuación.<br></br><a className="cla" href="https://thegraph.com/docs/es/network/indexing/" target="_blank" rel="noreferrer">Indexadores</a><br></br><a className="cla" href="https://thegraph.com/docs/es/network/curating/" target="_blank" rel="noreferrer">Curadores</a><br></br><a className="cla" href="https://thegraph.com/docs/es/network/delegating/" target="_blank" rel="noreferrer">Delegadores</a><br></br><br></br>Para garantizar la seguridad económica de The Graph Network y la integridad de los datos que se consultan, los participantes realizan stake usando Graph Tokens (GRT). GRT es un token de trabajo que es un ERC-20 en la blockchain de Ethereum, que se utiliza para asignar recursos en la red. Los Indexadores, Curadores y Delegadores activos pueden brindar servicios y obtener ingresos de la red, proporcionales a la cantidad de trabajo que realizan y su participación en GRT.</a>
    ,
  );
...
// Buy Start
handleBuy() {
  const message = this.createChatbotMessage(<a>Puedess ver el precio y todos los mercados abiertos en <a className="cla" href="https://coinmarketcap.com/currencies/the-graph/markets/" target="_blank" rel="noreferrer">CoinMarketCap</a>.</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleGRTTokenAddress() {
  const message = this.createChatbotMessage(<a>Dirección del token de GRT: 0xc944e90c64b2c07662a292be6244bdf05cda44a7</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
// Discord Start
handleDiscord() {
  const message = this.createChatbotMessage(<a>A continuación encontrará los servidores <strong>Oficiales</strong> de Discord.<br></br><br></br><a className="cla" href="https://discord.com/invite/vtvv7FP" target="_blank" rel="noreferrer">Protocolo Graph</a><br></br><br></br><a className="cla" href="https://discord.com/invite/aZtCCKPp34" target="_blank" rel="noreferrer">Graph AdvocatesDAO</a><hr></hr>A continuación encontrará los servidores de Discord <strong>no oficiales</strong>.<br></br><br></br><a className="cla" href="https://discord.com/invite/zqrwSFFW3F" target="_blank" rel="noreferrer">Graphrica</a></a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleTokenEconomics() {
  const message = this.createChatbotMessage(<a>La economía de fichas de Graph es bastante compleja. Además de un cronograma de emisión de tokens y un mecanismo de quemado de tokens, The Graph Protocol desbloquea tokens adquiridos durante un período de 5 a 10 años.<hr></hr><table><tr className="indexer-table-header">
  <th>Suministro total de tokens = </th>
  <th> Suministro inicial de tokens + </th>
  <th> Emisión anual - </th>
  <th> Quema anual</th>
</tr>
</table><hr></hr><strong>Descripción general de la economía del token GRT</strong><br></br><br></br><table>
<tr className="indexer-table">
  <td><strong>Ficha Símbolo</strong></td>
  <td>GRT</td>
</tr>
<tr className="indexer-table">
...
// Tenderize Start
handleTenderize() {
  const message = this.createChatbotMessage(<a>Durante Graph Day, Tenderize recibió un reconocimiento como el primer protocolo de participación líquida. Los usuarios pueden depositar $GRT por tenderGRT (tGRT), que automáticamente acumula recompensas y se intercambia de un lado a otro a voluntad. Los titulares de $GRT pueden delegar a través de Tenderize, otorgándoles tGRT. Una versión tokenizada de la posición apostada que combina automáticamente las recompensas y que se puede volver a cambiar instantáneamente a GRT.<br></br><br></br>Para comenzar, visite <a className="cla" href="https://app.tenderize.me/stakers/graph" target="_blank" rel="noreferrer">Tenderize</a>.<br></br><br></br>También puede leer el blog Tenderize <a className="cla" href="https://blog.tenderize.me/" target="_blank" rel="noreferrer">aquí</a>.</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
// Geo Start
handleGeo() {
  const message = this.createChatbotMessage(<a>Geo es un navegador web3 descentralizado basado en The Graph, las páginas están abiertas y seleccionadas por la comunidad. Así que puedes votar sobre lo que es valioso y tu voto cuenta. Geo está resolviendo todos los problemas que tenemos actualmente con nuestros navegadores web2 y está abriendo una nueva ventana de innovación, una nueva Internet donde su privacidad es la máxima prioridad. No tienes que saber nada sobre criptografía o blockchain para poder usarlo. Esta es una experiencia para incorporar a los próximos 1.000 millones de usuarios a web3.<br></br><br></br>Geo está en versión beta y solo es compatible con dispositivos iPad y Mac en este momento, regístrese para la lista de espera beta <a className="cla" href="https://edgeandnode.com/geo/" target="_blank" rel="noreferrer">aquí</a>.<br></br><br></br>Para leer un blog completo sobre Geo creado por <a className="cla" href="https://substack.com/profile/45913426-ahmad-mardni" target="_blank" rel="noreferrer">Ahmad Mardeni</a> consulte <a className="cla" href="https://ahmadmardeni.substack.com/p/geo-the-new-web3-browser-with-a-decentralization?s=r" target="_blank" rel="noreferrer">aquí</a>.<hr></hr><strong>ACTUALIZADO</strong> - Geo Génesis<br></br><br></br>Yaniv - Hace cinco años, un grupo de nosotros vimos la actividad que sucedía alrededor de Ethereum y decidimos contribuir construyendo The Graph. Vi el potencial de The Graph para ser un gráfico de conocimiento global descentralizado de todo el conocimiento y la información públicos del mundo. Al utilizar la infraestructura pública para organizar y brindar información, podríamos tener mejores procesos abiertos y justos para influir en qué información se considera verdadera. Hoy tenemos una red descentralizada vibrante y The Graph está resolviendo el problema crítico de acceder de manera eficiente a los datos de la blockchain para miles de desarrolladores, pero aún tenemos que dar un paso más para que la visión completa cobre vida.<br></br><br></br>Puedess leer el blog completo, <a className="cla" href="https://www.geobrowser.io/blog/post/introducing-geo-genesis?s=09" target="_blank" rel="noreferrer">aquí</a>.<br></br><br></br><Embed className="embed" isDark url='https://twitter.com/i/status/1532418078700580869'/></a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
// Graphtronauts Start
handleGraphtronauts() {
  const message = this.createChatbotMessage(<a><strong>Una comunidad para Delegadores, construida por Delegadores.</strong><br></br>Los Graphtronauts son un grupo dedicado a facilitar el chat para aquellos que desean MANTENER $ GRT y hablar sobre los fundamentos del proyecto The Graph. No solo son la comunidad no oficial más grande de titulares de $GRT a largo plazo para el ecosistema The Graph, sino que su objetivo es ayudar a las personas en su viaje para convertirse en Delegadores de The Graph.<br></br><br></br><strong>'Nos levantamos levantando a otros' - Graphtronauts | Fundada el 16 de enero de 2021</strong><br></br><br></br>Obtenga más información sobre los Graphtronauts escuchando este <a className="cla" href="https://www.grtiq.com/grtiq-podcast-35-the-graphtronauts/" target="_blank" rel="noreferrer">podcast de GRTiQ</a> con Baghe y Chris Ewing.<br></br>Y este <a className="cla" href="https://www.grtiq.com/grtiq-podcast-90-paolo-diomede/" target="_blank" rel="noreferrer">podcast de GRTiQ</a> con Paolo Diomede.<br></br>Puedess unirte a la comunidad a través de los siguientes enlaces:<br></br><a className="cla" href="https://t.me/graphtronauts" target="_blank" rel="noreferrer">Telegrama</a><br></br><a className="cla" href="https://twitter.com/graphtronauts" target="_blank" rel="noreferrer">Twitter</a><br></br><a className="cla" href="https://www.graphtronauts.com/#/" target="_blank" rel="noreferrer">Aplicación Graphtronauts</a><br></br><a className="cla" href="https://old.graphtronauts.com/" target="_blank" rel="noreferrer">Sitio web</a><br></br><a className="cla" href="https://www.youtube.com/channel/UCPAUeNaRtBV-jdSKY8wmcXg" target="_blank" rel="noreferrer">YouTube</a><br></br><a className="cla" href="https://www.reddit.com/r/Graphtronauts/" target="_blank" rel="noreferrer">Reddit</a><hr></hr>Los Graphtronauts pronto pondrán en marcha su propio Indexer, consulte el Tweet a continuación para obtener más información y síganos en Twitter.<br></br><Embed className="embed" isDark url='https://twitter.com/graphtronauts_x/status/1587932968341082112?s=46&t=zELvTyyPTQFMoeXK0OeaNA'/>
  </a>
    ,
  );
  this.setState((prev) => ({
...
handleDelegateWithWallet() {
  const message = this.createChatbotMessage(<a>Si desea delegar GRT a través de Metamask. Si aún no lo ha hecho, <a className="cla" href="https://metamask.io/download/" target="_blank" rel="noreferrer">descargue MetaMask</a>. Si necesita ayuda con esto, puede encontrar una guía <a className="cla" href="https://blog.wetrust.io/how-to-install-and-use-metamask-7210720ca047" target="_blank" rel="noreferrer">aquí</a>.<br></br><br></br>Puedes ver un video tutorial paso a paso sobre cómo delegar GRT a un Indexador <a className="cla" href="https://thegraph.academy/delegators/how-to-delegate-grt-tokens/" target="_blank" rel="noreferrer">aquí</a>.<br></br>Si prefiere seguir la guía de texto, puede leerla <a className="cla" href="https://thegraph.academy/delegators/how-to-delegate-grt-tokens/" target="_blank" rel="noreferrer">aquí</a>.<hr></hr>Puedes usar <strong>WalletConnect</strong> para delegar en The Graph Protocol.<br></br>Puedes encontrar una guía paso a paso sobre cómo hacer esto <a className="cla" href="https://thegraph.academy/delegators/delegating-walletconnect/" target="_blank" rel="noreferrer">aquí</a>.<br></br><br></br>En lugar de la billetera blanda de Metamask, también puede usar una billetera dura, como Ledger, para delegar su GRT. Las billeteras duras pueden agregar otra capa de seguridad, ya que generalmente requieren la confirmación de transacciones del dispositivo físico. Puedes conectar Metamask a su billetera de hardware a través de Metamask Browser Extension. Asegúrese de tener abierta la aplicación ETH en su dispositivo Ledger y de tener permitidos los datos de contrato dentro de la aplicación ETH de su dispositivo.<br></br><br></br>Para delegar sus tokens GRT usando una billetera de hardware conectada a MetaMask, lea un tutorial <a className="cla" href="https://medium.com/@OG-Graphtronauts/how-to-delegate-your-grt-tokens-with-an-hardware-wallet-aec7751cd5d5" target="_blank" rel="noreferrer">aquí</a>.</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleCurator() {
  const message = this.createChatbotMessage(<a><a className="cla" href="https://thegraph.com/docs/es/network/curating/" target="_blank" rel="noreferrer">Los Curadores </a> no necesitan poseer habilidades o conocimientos técnicos complejos. Todo lo que se necesita es la capacidad de realizar transacciones a través de MetaMask. Del mismo modo, los Curadores no están obligados a apostar una cantidad mínima requerida de GRT, a diferencia de los Indexadores. Los Curadores deben comprender las tendencias del ecosistema Web3 y ver si un subgrafo proporciona información útil. También es útil para un curador poder identificar problemas críticos que podrían significar que un subgrafo está roto.<br></br><br></br>Las siguientes guías le brindarán toda la información que necesita saber antes de señalar un subgrafo y cómo hacerlo con confianza.<br></br><br></br>Esta <a className="cla" href="https://medium.com/@paulieb.eth/tips-and-tricks-to-evaluate-and-determine-if-a-subgraph-is-legitimate-c67f16e2205a" target="_blank" rel="noreferrer">guía</a> del curador sobre "Consejos y trucos para evaluar y determinar si un subgrafo es legítimo" es el mejor lugar para comenzar. Una vez que haya leído la guía y haya visto los tutoriales a continuación, estará en una excelente posición para señalar su primer subgrafo.<br></br><br></br>Únase a <a className="cla" href="https://t.me/CurationStation" target="_blank" rel="noreferrer">$GRT Curation Station</a>, una comunidad creada por Curators, para Curators. Puedes buscar más ayuda aquí si es necesario.<br></br><br></br>Los siguientes videos tutoriales fueron creados por <a className="cla" href="https://thegraph.com/explorer/profile?id=0x87eba079059b75504c734820d6cf828476754b83&view=Indexing" target="_blank" rel="noreferrer">DataNexus</a> sobre Curation:<br></br><a className="cla" href="https://www.youtube.com/watch?v=-7qWi2do-1E" target="_blank" rel="noreferrer">¿Qué es un curador para The Graph?</a><br></br><a className="cla" href="https://www.youtube.com/watch?v=unzQvSZIORg" target="_blank" rel="noreferrer">Verificación de un subgrafo</a><br></br><a className="cla" href="https://www.youtube.com/watch?v=zJswFILfADg" target="_blank" rel="noreferrer">Cómo señalar un subgrafo</a><br></br><a className="cla" href="https://www.youtube.com/watch?v=u76dxQPdS9c" target="_blank" rel="noreferrer">Error de transacción de señal</a><hr></hr>Si desea algunas herramientas útiles de Curator, solo pregunte.</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleChainlink() {
  const message = this.createChatbotMessage(<a>The Graph es un protocolo de indexación para consultar redes como Ethereum e IPFS. Cualquiera puede crear y publicar API abiertas, llamadas subgrafos, lo que facilita el acceso a los datos.<hr></hr>Chainlink es una red Oracle descentralizada que permite que los contratos inteligentes accedan de forma segura a fuentes de datos  off-chain, API web y pagos bancarios tradicionales.<hr></hr>Aquí hay una explicación en video con Tegan Kline y Dave Kajpust de The Graph Protocol. Discuten la importancia vital de The Graph para construir una Web3 descentralizada y explican las diferencias entre Chainlink y Graph.<br></br><br></br><Embed className="embed" isDark url='https://www.youtube.com/watch?v=HOS9g0rKP24'/></a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleCoreDevs() {
  const message = this.createChatbotMessage(<a>Los desarrolladores principales de Graph son:<br></br><br></br><a className="cla" href="https://edgeandnode.com/blog/introducing-edge-and-node/" target="_blank"><strong>Edge & Node</strong></a> - Desarrollo de protocolos descentralizados y avance web3. Equipo inicial detrás de The Graph.<br></br><a className="cla" href="https://www.figment.io/protocols/the-graph" target="_blank"><strong>Figment</strong></a> - Mejora de la infraestructura de nodos y soporte multi-blockchain.<br></br><a className="cla" href="https://thegraph.com/blog/announcing-the-graph-foundation" target="_blank"><strong>The Graph Foundation</strong></a> - Administrar el ecosistema, otorgar subvenciones y apoyar a la comunidad.<br></br><a className="cla" href="https://www.streamingfast.io/" target="_blank"><strong>StreamingFast</strong></a> - Optimización del rendimiento de indexación de subgrafos y soporte de herramientas de desarrollo web3.<br></br><a className="cla" href="https://www.semiotic.ai/" target="_blank" ><strong>Semiotic</strong></a>- Mejorando The Graph Network a través de innovaciones de R&D.<br></br><a className="cla"href="https://www.the-guild.dev/" target="_blank"><strong>The Guild</strong></a> - Crear herramientas de subgrafos y desarrollar mejoras en la API de GraphQL.<br></br><a className="cla" href="https://graphops.xyz/" target="_blank"><strong>GraphOps</strong></a> - Extracción, transformación y servicio de datos de blockchain a través del Graph Protocol.<br></br><a className="cla" href="https://messari.io/report/the-graph-foundation-awards-messari-usd12-5mm-in-first-ever-core-subgraph-developer-grant-to-build-and-standardize-subgraphs" target="_blank"><strong>Messari</strong></a> - Aportando transparencia y construyendo herramientas para decisiones e inversiones informadas.<br></br><br></br>Pregunte acerca de cualquiera de los desarrolladores principales para obtener más información.<br></br><br></br>Póngase al día con todas las llamadas de desarrolladores principales <a className="cla" href="https://www.youtube.com/playlist?list=PLTqyKgxaGF3Tj_A6eqV8V_aQoRwd2oHa_" target="_blank">aquí</a>.</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleFigment() {
  const message = this.createChatbotMessage(<a>Figment es una empresa canadiense registrada y financiada con capital de riesgo con sede en Toronto. Sirviendo a los tenedores de GRT más grandes del mundo. Con más de 30 años de experiencia escalando con éxito empresas de infraestructura de Internet.<hr></hr><strong>Staking</strong>- Figment opera una red altamente segura de validadores de prueba de participación (PoS) que permiten a los poseedores de tokens asegurar redes, participar en la gobernanza y obtener rendimiento.<br></br>Para obtener más información sobre Staking con Figment, consulte <a className="cla" href="https://www.figment.io/protocols/the-graph" target="_blank" rel="noreferrer">aquí</a>.<br></br><br></br><strong>Software</strong>- La plataforma DataHub de Figment permite a los desarrolladores utilizar las funciones más potentes y exclusivas de una blockchain sin tener que convertirse en expertos en protocolos, lo que acelera el desarrollo de nuevas aplicaciones Web 3.<br></br>Para obtener más información sobre la plataforma DataHub de Figment, consulte <a className="cla" href="https://datahub.figment.io/" target="_blank" rel="noreferrer">aquí</a>.<br></br><br></br><strong>Capital</strong>- Figment Capital ofrece financiación inicial y apoyo al crecimiento de proyectos PoS nuevos y altamente innovadores.<hr></hr>Los desarrolladores que usan subgrafos pueden monitorear fácilmente sus subgrafos dentro de DataHub. Esto ayuda a los desarrolladores a mejorar el rendimiento y la confiabilidad de sus subgrafos.<br></br>Puedes leer acerca de Llevar The Graph al ecosistema del cosmos, <a className="cla" href="https://www.figment.io/resources/the-graph-and-cosmos" target="_blank" rel="noreferrer">aquí</a>.<hr></hr><a className="cla" href="https://twitter.com/blockya_?s=21&t=_AHHnNQtdCGiQCZd0gn2MA" target="_blank" rel="noreferrer">Lorena Fabris</a> de <a className="cla" href="https://twitter.com/espanolgraph?s=21&t=mAEXMZH5ZSdPi-3W3mSb_Q" target="_blank" rel="noreferrer">The Graph Español</a> ha creado los siguientes tutoriales para la comunidad.<br></br><br></br><a className="cla" href="https://fabris-86569.medium.com/figment-se-une-a-the-graph-en-una-de-las-mayores-fusiones-en-un-protocolo-descentralizado-se-3365717c8016" target="_blank" rel="noreferrer">Figment se une a The Graph en Una de las Mayores Fusiones en un Protocolo Descentralizado; Se otorga una Grants para Core Desarrolladores de 80 Millones de GRT</a></a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleGraphQLApi() {
  const message = this.createChatbotMessage(<a><strong>API GraphQL</strong><br></br><br></br>Esta <a className="cla" href="https://thegraph.com/docs/es/querying/graphql-api/" target="_blank" rel="noreferrer">guía</a> explica la API de consulta de GraphQL que se utiliza para el protocolo Graph.<br></br><br></br><strong><a className="cla" href="https://thegraph.com/docs/es/querying/graphql-api/#queries" target="_blank" rel="noreferrer">Consultas</a></strong> - En su esquema de subgrafo, define tipos llamados Entidades. Para cada tipo de entidad, se generará un campo de entidad y entidades en el tipo de consulta de nivel superior.<br></br><br></br><strong><a className="cla" href="https://thegraph.com/docs/es/querying/graphql-api/#sorting" target="_blank" rel="noreferrer">Clasificación</a></strong> - Al consultar una colección, el parámetro orderBy puede usarse para ordenar por un atributo específico. Además, orderDirection se puede usar para especificar la dirección de clasificación, asc para ascender o desc para descender.<br></br><br></br><strong><a className="cla" href="https://thegraph.com/docs/es/querying/graphql-api/#pagination" target="_blank" rel="noreferrer">Paginación</a></strong> - Al consultar una colección, el primer parámetro se puede usar para paginar desde el principio de la colección.<br></br><br></br><strong><a className="cla" href="https://thegraph.com/docs/es/querying/graphql-api/#filtering" target="_blank" rel="noreferrer">Filtrado</a></strong> - Puedes usar el parámetro where en sus consultas para filtrar por diferentes propiedades.<br></br><br></br><strong><a className="cla" href="https://thegraph.com/docs/es/querying/graphql-api/#time-travel-queries" target="_blank" rel="noreferrer">Consultas sobre viajes en el tiempo</a></strong> - Puedes consultar el estado de sus entidades no solo para el último bloque, que es el predeterminado, sino también para un bloque arbitrario en el pasado.<hr><a className="cla" href="https://twitter.com/blockya_?s=21&t=_AHHnNQtdCGiQCZd0gn2MA" target="_blank" rel="noreferrer">Lorena Fabris</a> de <a className="cla" href="https://twitter.com/espanolgraph?s=21&t=mAEXMZH5ZSdPi-3W3mSb_Q" target="_blank" rel="noreferrer">The Graph Español</a> ha creado los siguientes tutoriales para la comunidad.</hr><br></br><br></br><a className="cla" href="https://fabris-86569.medium.com/construir-apis-graphql-en-ethereum-4cc6645d1360" target="_blank" rel="noreferrer">Construir APIs GraphQL en Ethereum</a></a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleGraphOps() {
  const message = this.createChatbotMessage(<a>GraphOps está construyendo el futuro de la web. Su misión es: Nos impulsa la misión de construir una red sin censura, equitativa y auto-soberana. Los datos públicos están en el corazón de esa misión, y prosperamos en la creación de estándares y protocolos de datos abiertos para potenciar la próxima gran ola de instituciones y aplicaciones para nuestro mundo.<br></br><br></br>GraphOps es una empresa de infraestructura de datos de blockchain. Extraen, transforman y sirven datos de blockchain a través del Protocolo Graph.<hr></hr><a className="cla" href="https://twitter.com/blockya_?s=21&t=_AHHnNQtdCGiQCZd0gn2MA" target="_blank" rel="noreferrer">Lorena Fabris</a> de <a className="cla" href="https://twitter.com/espanolgraph?s=21&t=mAEXMZH5ZSdPi-3W3mSb_Q" target="_blank" rel="noreferrer">The Graph Español</a> ha creado los siguientes tutoriales para la comunidad.<br></br><br></br><a className="cla" href="https://fabris-86569.medium.com/the-graph-foundation-concede-un-grant-para-core-devs-a-graphops-c54f612a2bca" target="_blank" rel="noreferrer">The Graph Foundation Concede un Grant para Core Devs a GraphOps</a></a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleGraphDay() {
  const message = this.createChatbotMessage(<a>Aquí hay un resumen del Graph Day más reciente que tuvo lugar el 2 de junio de 2022 en el histórico Palacio de Bellas Artes de San Francisco.<hr></hr>Visite <a className="cla" href="https://thegraph.com/graph-day/2022/" target="_blank" rel="noreferrer">Graph Day</a> y <a className="cla" href="https://thegraph.com/graph-hack/2022/" target="_blank" rel="noreferrer">Graph Hack</a> para obtener más información sobre todo el evento.<hr></hr>La comunidad de Graph pudo unirse y centrarse en web3, dapps, protocolos y el futuro de Internet. Los principales desarrolladores de protocolos y dapps mostraron cómo la comunidad web3 es pionera en nuevas formas de coordinación humana.<br></br><br></br>Bienvenida por Eva Beylin, directora de The Graph Foundation. Seguido de una charla inspiradora de Yaniv Tal, cofundador de The Graph y director ejecutivo de Edge & Node. A continuación, la comunidad recibió una presentación de Graph sobre 'Por qué es importante la descentralización'. Luego llegaron los emocionantes anuncios, uno tras otro:<br></br>Anuncio de extinción del Servicio alojado<br></br>Anuncio de transmisión secundaria<br></br>Anuncio de lanzamiento de GEO<br></br>Luego, la comunidad fue invitada a una charla de panel con Diana Chen, Camila Ramos, Chris Ewing y Derek Meyer. -"Se necesita un pueblo".<br></br><br></br>Puedes escuchar el podcast de GRTiQ en Graph Day y Graph Hack con Tegan Kline, que tuvo lugar justo antes del evento, <a className="cla" href="https://www.grtiq.com/grtiq-podcast-special-release-graph-day/" target="_blank" rel="noreferrer">aquí</a>.<br></br><br></br>Vea el futuro de Internet a medida que se presenta en vivo desde The Graph Day 2022 Livestream a continuación.<br></br><br></br><Embed className="embed" isDark url='https://www.youtube.com/watch?v=yLQmdM5DWSk&list=PLTqyKgxaGF3T2Ginisuf2nUY6yDi_WbT3&index=11'/></a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleCoinbase() {
  const message = this.createChatbotMessage(<a>Cómo delegar sus tokens GRT con Coinbase Wallet<br></br><br></br>En este artículo, le enseñará cómo delegar sus tokens GRT dentro del protocolo The Graph, utilizando <a className="cla" href="https://www.coinbase.com/wallet" target="_blank">Coinbase Wallet</a>.<br></br><br></br>Para leer la guía realizada por los Graphtronauts, ver <a className="cla" href="https://medium.com/@OG-Graphtronauts/how-to-delegate-your-grt-tokens-with-coinbase-wallet-85168f84e95e" target="_blank">aquí</a>. O si prefiere ver un video tutorial, lo encontrará a continuación.<br></br><br></br><Embed className="embed" isDark url='https://www.youtube.com/watch?v=1KU_mVDStIk&t=2s'/></a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleCryptocurrencies() {
  const message = this.createChatbotMessage(<a>El nombre es una combinación, o un acrónimo, de criptografía y moneda. A diferencia de las monedas tradicionales (generalmente denominadas "monedas fiduciarias"), que usan billetes y monedas físicos, las criptomonedas son completamente digitales. Al igual que cualquier otra moneda, puede usar la criptomoneda para comprar bienes y servicios, y puede transferirla entre amigos y familiares en todo el mundo. Sin embargo, la criptomoneda tiene algunas características adicionales que la diferencian de las monedas tradicionales.<br></br><br></br>Cuando deposita moneda fiduciaria en un banco, esencialmente está prestando su dinero a ese banco y confiando en que se lo devolverán cuando lo solicite. Si bien esto generalmente funciona bien para ambas partes, los bancos se benefician de su dinero prestándolo a otros y cobrando intereses sobre estos préstamos. Además, los bancos cobran tarifas adicionales, como tarifas de retiro o tarifas de cuenta mensuales, y también pueden tener requisitos de saldo mínimo.<br></br><br></br>Un banco tradicional se consideraría centralizado, la criptomoneda está descentralizada, lo que significa que no tiene una sola persona que controle todo; de hecho, hay miles de personas que ayudan a validar todas las transacciones que ocurren en una blockchain, y eso significa que tienes un entorno sin confianza, reconciliación de datos mejorada y puntos débiles reducidos. Esa es una manera prolija de decir que controlas tus propios activos.<br></br><br></br>La mayor privacidad, seguridad, portabilidad y transparencia de las criptomonedas significa que no hay espacio para manipular transacciones, cambiar el suministro de dinero o ajustar las reglas a mitad del juego. Las criptomonedas no son una organización, no controlan sus fondos; puedes ser tu propio banco.</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleWhatIsABlockchain() {
  const message = this.createChatbotMessage(<a>Blockchain se puede considerar como un libro de registro que se utiliza para rastrear transacciones de criptomonedas de la misma manera que se rastrea el gasto de la chequera con un registro de chequera. Una blockchain es un sistema para registrar transacciones realizadas con criptomonedas, como ETH o Bitcoin. Los datos de transacciones se almacenan en un bloque de muchas transacciones. Una vez que un bloque está lleno, se crea un nuevo bloque que hace referencia al bloque anterior y se encadena al bloque anterior; de ahí el término blockchain.<br></br><br></br>Algunas blockchains, como Ethereum, se mantienen utilizando una red de computadoras entre pares, lo que permite que cualquier usuario aloje y acceda a la blockchain desde cualquier parte del mundo. A medida que ocurre una transacción, se registra y distribuye al libro de registro de cada usuario en la red blockchain.<br></br><br></br>Estas computadoras individuales, cuando se usan juntas, forman una base de datos global descentralizada para almacenar todos los datos de la blockchain. Descentralizado significa que, en lugar de que los datos se administren en una ubicación y sean controlados por una sola empresa o persona, todos los que usan la red los administran.<br></br><br></br>Las blockchains están diseñadas para ser inmutables, es decir, inmutables. Una vez que algo se ha registrado en la blockchain, no se puede cambiar ni revertir. Esto significa que cualquier transacción en la blockchain es permanente y siempre habrá un registro disponible para que cualquiera lo vea. La descentralización combinada con la estructura de datos de blockchain crea una línea de tiempo permanente de eventos.<br></br><br></br>Algunos bancos requieren que se comunique con ellos para ver las transacciones que tienen más de un mes en su cuenta. El uso de la blockchain eliminaría la necesidad de ponerse en contacto con su banco porque todas sus transacciones ya estarán disponibles para que las vea.</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handlePOS() {
  const message = this.createChatbotMessage(<a>Al igual que la Prueba de trabajo, la Prueba de participación (PoS) es un algoritmo de consenso que se basa en la cantidad de monedas que se están apostando. Staking se refiere a comprometer fondos en el sistema para ser un validador de bloque; los validadores solo pueden participar en el proceso de producción de nuevos bloques si sus monedas están bloqueadas. Luego, los fondos actúan como garantía, lo que significa que un validador malicioso perdería sus fondos apostados y perdería el acceso a la red.<br></br><br></br>PoS es una alternativa a PoW que viene con ciertas ventajas y desventajas. En Prueba de trabajo solo se premia al minero y todos compiten por ser el que presenta el bloque válido, desperdiciando así mucha energía. El modelo de prueba de participación logra el consenso al considerar el tamaño de la participación y cuánto tiempo han estado apostados, luego seleccionando el validador que ahorra una cantidad considerable de energía y tiempo.<br></br><br></br><table><tr className="indexer-table-header">
...
<br></br><br></br>
<tr className="indexer-table">
  <td>LNivel de entrada inferior: solo necesita gastar dinero una vez para participar en un modelo de prueba de participación. Un sistema PoW requiere equipo de hardware y tiempo de actividad continuo.</td>
  <td>Centralización: existe un incentivo para tener más tokens para apostar. Algunas blockchains han comenzado a castigar esto e incentivar validadores más pequeños.</td>
</tr>
</table></a>
    ,
  );
...
handleCEX() {
  const message = this.createChatbotMessage(<a>Un intercambio centralizado (CEX) es una forma de facilitar los intercambios entre usuarios manteniendo un libro de pedidos; una colección de órdenes de compra y venta que colocan los inversores individuales. Las órdenes son para comprar o vender una cierta cantidad de criptomonedas a un precio específico: un CEX agregará estas órdenes y las ejecutará.<br></br><br></br>Una gran diferencia entre un CEX y las billeteras personales o un DEX es que los usuarios en realidad no intercambian criptomonedas o fiat entre sí. Los fondos se depositan y el intercambio se hace cargo de la custodia de los activos y básicamente emite un pagaré al comerciante. Esto tiene ventajas, como tarifas más bajas y un intercambio más simple, pero también desventajas, como la falta de transparencia que permite prácticas maliciosas como el comercio de lavado y la manipulación de precios.<br></br><br></br>Dado que todos los fondos están bajo custodia del intercambio, los CEX son un objetivo principal para posibles ataques y han sido atacados varias veces en los últimos años por cientos de millones de dólares. Además, debido a que un CEX está alojado en algún lugar, es posible que haya problemas técnicos o ataques que pueden generar tiempo de inactividad. Los fondos también pueden congelarse y confiscarse debido a las regulaciones gubernamentales en algunos casos.<br></br><br></br>Si bien un CEX requerirá que se lleve a cabo Conozca a su cliente, también es útil para fines fiscales tener esta información fácilmente disponible y la mayoría de los intercambios pueden proporcionarle documentos fiscales fácilmente. Tener un CEX que tome la custodia de sus fondos tiene ventajas si no se siente cómodo controlándolos usted mismo. Algunos usuarios han almacenado fondos en sus billeteras personales y han olvidado frases iniciales o han perdido sus claves privadas, perdiendo millones de dólares en criptomonedas.<br></br><br></br>Algunos ejemplos de CEX populares incluyen Binance, Coinbase, FTX, Huobi y Kucoin.</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleDEX() {
  const message = this.createChatbotMessage(<a>Un intercambio descentralizado es un mercado entre pares donde las transacciones van directamente entre los comerciantes. Este es el núcleo de los valores criptográficos de ser descentralizados: los bancos, corredores o cualquier otro intermediario oficial no fomentan las transacciones. Hay algunos DEX populares como Uniswap y Sushiwap que se ejecutan en Ethereum L1.<br></br><br></br>La mayor diferencia entre un intercambio centralizado (CEX) y un DEX es que un CEX permitirá intercambios entre moneda fiduciaria y criptografía mientras que un DEX no. Un CEX permitirá operaciones de margen y establecer órdenes de límite que son manejadas por el libro de órdenes; esto es similar a las bolsas de valores como Nasdaq.<br></br><br></br>Un DEX se basa completamente en contratos inteligentes. Establecen los precios de las criptomonedas algorítmicamente y utilizan fondos de liquidez (LP) para facilitar las operaciones que se liquidan directamente en la blockchain. Un DEX normalmente se basa en un código de fuente abierta, lo que significa que no hay nada oculto sobre su funcionamiento.<br></br><br></br>Encontrará más variedad en un DEX, DeFi es el lugar ideal para ingresar a los primeros LP de token. Esto va desde tokens conocidos hasta aleatorios y, a veces, inútiles, asegúrese de hacer su propia investigación al invertir. Dicho esto, el riesgo de piratería se reduce drásticamente porque los fondos en un DEX se almacenan en billeteras personales y no en una tienda central; ha habido varios hacks en CEX a lo largo de los años.<br></br><br></br>Un CEX requerirá Conozca a su cliente para identificarlo, un DEX no requerirá ninguna información de identificación personal para que permanezca en el anonimato. Además, aunque algunas ubicaciones no podrán permitir compras de criptomonedas, un DEX abre la posibilidad a las personas de estas regiones.</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleNFT() {
  const message = this.createChatbotMessage(<a>Presentado por Dieter Shirley en septiembre de 2017 y finalizado en junio de 2018, el ERC-721 fue diseñado para tokens no fungibles. Son únicos, ningún token es exactamente igual y se les asigna una variable uint256 llamada tokenId que debe ser única. Esto podría representar casi cualquier cosa en el mundo que sea única y que necesite una propiedad demostrable:<br></br><br></br>Arte digital (GIF, coleccionables, música, videos)<br></br>un nombre de dominio<br></br>escrituras de un coche<br></br>Entradas para un evento del mundo real<br></br>Facturas tokenizadas<br></br>Documentos legales<br></br>Registros médicos<br></br>firmas<br></br><br></br>Los NFT tienen propiedades especiales:<br></br><br></br>Cada token acuñado tiene un identificador único que está directamente vinculado a una dirección de Ethereum.<br></br>No son directamente intercambiables con otros tokens 1:1. Por ejemplo, 1 ETH es exactamente lo mismo que otro ETH. Este no es el caso de las NFT.<br></br>Cada token tiene un propietario y esta información es fácilmente verificable.<br></br>Viven en Ethereum y se pueden comprar y vender en un mercado NFT basado en Ethereum.<br></br><br></br>Eso significa que si posee un NFT:<br></br><br></br>Puedess demostrar que lo posees.<br></br>El token prueba que su copia es el original.<br></br>Su clave privada es prueba de propiedad.<br></br>Nadie puede manipularlo de ninguna manera.<br></br>Puedess venderlo o mantenerlo para siempre.</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleArbitrum() {
  const message = this.createChatbotMessage(<a>Arbitrum es una solución de escalado para Ethereum que reduce drásticamente los costos y la latencia. Arbitrum ha lanzado Arbitrum One en la red principal de Ethereum, y el equipo se está preparando para su próximo lanzamiento al público.<br></br><br></br>Gracias a la integración con Arbitrum, los servicios de consulta e indexación de alojamiento de The Graph ahora están disponibles en la red. Los desarrolladores de Arbitrum One ahora podrán crear y publicar API abiertas (subgrafos) que las aplicaciones pueden consultar usando GraphQL.<br></br><br></br>Graph ya admite datos de indexación para Ethereum, IPFS, Celo, Avalanche, Fantom y Moonbeam. Además, miles de desarrolladores ya han creado más de 10 000 subgrafos para aplicaciones como DODO, MCDEX, Uniswap, Synthetic, Gnosis, Decentraland, etc. Al agregar Arbitrum a esa lista, los esfuerzos de expansión de The Graph han dado otro paso para unir el ecosistema Web3.Graph ya admite datos de indexación para Ethereum, IPFS, Celo, Avalanche, Fantom y Moonbeam. Además, miles de desarrolladores ya han creado más de 10 000 subgrafos para aplicaciones como DODO, MCDEX, Uniswap, Synthetic, Gnosis, Decentraland, etc. Al agregar Arbitrum a esa lista, los esfuerzos de expansión de The Graph han dado otro paso para unir el ecosistema Web3.<hr></hr><a className="cla" href="https://twitter.com/blockya_?s=21&t=_AHHnNQtdCGiQCZd0gn2MA" target="_blank" rel="noreferrer">Lorena Fabris</a> de <a className="cla" href="https://twitter.com/espanolgraph?s=21&t=mAEXMZH5ZSdPi-3W3mSb_Q" target="_blank" rel="noreferrer">The Graph Español</a> ha creado los siguientes tutoriales para la comunidad.<br></br><br></br><a className="cla" href="https://fabris-86569.medium.com/arbitrum-integra-the-graph-datos-abiertos-indexados-ahora-activos-en-la-capa-2-arbitrum-rollup-47ad397d01e0" target="_blank" rel="noreferrer">Arbitrum Integra The Graph, Datos Abiertos Indexados Ahora Activos en la capa 2 Arbitrum Rollup</a></a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleStatistics() {
  const message = this.createChatbotMessage(<a>Si está buscando datos / estadísticas en vivo. Entonces, por favor sea más específico. Aquí hay una lista de lo que puedes preguntarme:<br></br><br></br>Recuento de Delegadores activos<br></br>Recuento de delegaciones activas<br></br>Recuento de titulares<br></br>Recuento de subgrafos<br></br>Conteo de Curadores<br></br>Recuento de Indexadores activos<br></br>Recuento total de tarifas de consulta<br></br>GRT total apostado<br></br>GRT total delegado por los Delegadores<br></br>GRT total señalado por Curadores<br></br>GRT total delegado por Indexadores<br></br>GRT total quemado</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleBirthday() {
  ...
  handleButtonAmsterdam() {
    ...
    this.handleButtonSanFrancisco = this.handleButtonSanFrancisco .bind(this);
    this.handleButtonSingapore = this.handleButtonSingapore .bind(this);
      const message = this.createChatbotMessage(<a><a className="cla" href='https://twitter.com/colsongrteacher?s=21&t=G1z0E5ndRT5F549tsuRY2A' target="_blank" rel="noreferrer"><strong>Colson</strong></a> fue el anfitrión de The Graph, celebración de cumpleaños de 2 años en Amstel Boathouse en Amsterdam.<br></br><br></br>Esperando que se publique el contenido del evento...<br></br><br></br>También puede consultar los otros eventos a continuación.<br></br><br></br><button className="chatbot-button" onClick={this.handleButtonBuenosAires}><strong>Buenos Aires</strong></button><br class="no-show-monitor"></br><button className="chatbot-button" onClick={this.handleButtonDubai}><strong>Dubái</strong></button><br class="no-show-monitor"></br><button className="chatbot-button" onClick={this.handleButtonLagos}><strong>Lagos</strong></button><br class="no-show-monitor"></br><button className="chatbot-button" onClick={this.handleButtonSanFrancisco}><strong>San Francisco</strong></button><br class="no-show-monitor"></br><button className="chatbot-button" onClick={this.handleButtonSingapore}><strong>Singapur</strong></button></a>
        ,
      );
      this.setState((prev) => ({
        ...prev,
  ...
  handleNews() {
    const message = this.createChatbotMessage(<a>Si desea mantenerse al día con las últimas noticias sobre The Graph, nuevos anuncios de asociación y leer sobre lo que está sucediendo dentro de la comunidad, los enlaces a continuación pueden ayudarlo con eso.<br></br><br></br><a className="cla" href="https://thegraph.com/blog/" target="_blank" rel="noreferrer">The Graph Blog</a><br></br><br></br><a className="cla" href="/GraphAdvocatesSpotlight" target="_blank" rel="noreferrer">Graph Advocates Spotlight</a><hr></hr>Asegúrate de seguir también a The Graph en <a className="cla" href="https://twitter.com/graphprotocol" target="_blank" rel="noreferrer">Twitter</a>.</a>
      ,
    );
    this.setState((prev) => ({
      ...prev,
...
handleButtonTheGraph() {
  ...
  const message = this.createChatbotMessage(<a><button className="chatbot-button" onClick={() => {
    ...
    this.handleRoles();
    this.handleButtonTheGraph();
  }}><strong>Funciones del ecosistema</strong></button><br class="no-show-monitor"></br><button className="chatbot-button" onClick={() => {
    this.handleJob();
    this.handleButtonTheGraph();
  }}><strong>Trabajos</strong></button><br class="no-show-monitor"></br><button className="chatbot-button" onClick={() => {
    this.handleBirthday();
    this.handleButtonTheGraph();
  }}><strong>Cumpleaños</strong></button><br class="no-show-monitor"></br><button className="chatbot-button" onClick={() => {
    this.handleGraphDay();
    this.handleButtonTheGraph();
  }}><strong>Graph Día</strong></button><br class="no-show-monitor"></br><button className="chatbot-button" onClick={() => {
    this.handleParticipantUpdate();
    this.handleButtonTheGraph();
  }}><strong>Actualización del participante</strong></button><br class="no-show-monitor"></br><button className="chatbot-button" onClick={() => {
    this.handleGeo();
    this.handleButtonTheGraph();
    ...
    this.handleButtonTheGraph();
  }}><strong>Fondos</strong></button><br class="no-show-monitor"></br>
  ...
  <button className="chatbot-button" onClick={() => {
    ...
    this.handleButtonTheGraph();
  }}><strong>GRT Token Señas</strong></button>
...
handleButtonCoreDevs() {
  ...
  const message = this.createChatbotMessage(<a><button className="chatbot-button" onClick={() => {
    this.handleEdgeAndNode();
    this.handleButtonCoreDevs();
  }}><strong>Edge y Node</strong></button><br class="no-show-monitor"></br><button className="chatbot-button" onClick={() => {
    this.handleFigment();
    this.handleButtonCoreDevs();
  }}><strong>Figment</strong></button><br class="no-show-monitor"></br><button className="chatbot-button" onClick={() => {
    this.handleTheGraphFoundation();
...
handleButtonDelegator() {
  ...
  const message = this.createChatbotMessage(<a><button className="chatbot-button" onClick={() => {
  ...
  }}><strong>Delegator Guía</strong></button><br class="no-show-monitor"></br><button className="chatbot-button" onClick={() => {
    this.handleDelegateWithWallet();
    this.handleButtonDelegator();
  }}><strong>Delegate con Cartera</strong></button><br class="no-show-monitor"></br><button className="chatbot-button" onClick={() => {
    this.handleCoinbase();
    this.handleButtonDelegator();
  }}><strong>Delegate de Coinbase Cartera</strong></button><br class="no-show-monitor"></br><button className="chatbot-button" onClick={() => {
    this.handleFeesToDelegate();
    this.handleButtonDelegator();
  }}><strong>Delegation Derechos</strong></button><br class="no-show-monitor"></br><button className="chatbot-button" onClick={() => {
    ...
    this.handleButtonDelegator();
  }}><strong>Eligiendo un Indexer</strong></button><br class="no-show-monitor"></br><button className="chatbot-button" onClick={() => {
    this.handleIndexerCompare();
    this.handleButtonDelegator();
  }}><strong>Comparar Indexers</strong></button><br class="no-show-monitor"></br><button className="chatbot-button" onClick={() => {
    this.handleActiveDelegatorCount();
    this.handleButtonDelegator();
  }}><strong>Active Delegator Contar</strong></button><br class="no-show-monitor"></br><button className="chatbot-button" onClick={() => {
    this.handleActiveDelegationCount();
    this.handleButtonDelegator();
  }}><strong>Active Delegation Contar</strong></button><br class="no-show-monitor"></br><button className="chatbot-button" onClick={() => {
    this.handleTotalGRTDelegatedByDelegators();
    this.handleButtonDelegator();
  }}><strong>Total GRT Delegated Por Delegators</strong></button><hr></hr><button className="chatbot-button" onClick={this.handleButtonMenu}><strong>Menú Categorías</strong></button></a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleButtonCurator() { 
  ...
  const message = this.createChatbotMessage(<a><button className="chatbot-button" onClick={() => {
    ...
    this.handleButtonCurator();
  }}><strong>Curator Instrumentos</strong></button><br class="no-show-monitor"></br><button className="chatbot-button" onClick={() => {
    this.handleCuratorsCount();
    this.handleButtonCurator();
  }}><strong>Curator Contar</strong></button><br class="no-show-monitor"></br><button className="chatbot-button" onClick={() => {
    this.handleTotalGRTSignalledByCurators();
    this.handleButtonCurator();
  }}><strong>Total GRT Signalled Por Curators</strong></button><hr></hr><button className="chatbot-button" onClick={this.handleButtonMenu}><strong>Menú Categorías</strong></button></a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleButtonIndexer() { 
  ...
  const message = this.createChatbotMessage(<a><button className="chatbot-button" onClick={() => {
  ...
  }}><strong>Eligiendo Indexers</strong></button><br class="no-show-monitor"></br><button className="chatbot-button" onClick={() => {
    this.handleIndexerCompare();
    this.handleButtonIndexer();
  }}><strong>Comparar Indexers</strong></button><br class="no-show-monitor"></br><button className="chatbot-button" onClick={() => {
    this.handleBecomeIndexer();
    this.handleButtonIndexer();
  }}><strong>Convertirse en Indexer</strong></button><br class="no-show-monitor"></br><button className="chatbot-button" onClick={() => {
    this.handleIndexerHardwareRequirements();
    this.handleButtonIndexer();
  }}><strong>Indexer Requisitos de hardware</strong></button><br class="no-show-monitor"></br><button className="chatbot-button" onClick={() => {
    this.handleIndexerMap();
    this.handleButtonIndexer();
  }}><strong>Indexer Mapa</strong></button><br class="no-show-monitor"></br><button className="chatbot-button" onClick={() => {
    ...
    this.handleButtonIndexer();
  }}><strong>Indexer Recompensas</strong></button><br class="no-show-monitor"></br><button className="chatbot-button" onClick={() => {
    this.handleQueryFeesAndIndexingRewardCut();
    this.handleButtonIndexer();
  }}><strong>Query Derechos y Indexing Corte de Recompensas</strong></button><br class="no-show-monitor"></br><button className="chatbot-button" onClick={() => {
 ...
 <button className="chatbot-button" onClick={() => {
    ...
    this.handleButtonIndexer();
  }}><strong>Active Indexer Contar</strong></button><br class="no-show-monitor"></br><button className="chatbot-button" onClick={() => {
    this.handleTotalDelegatedGRTByIndexersCount();
    this.handleButtonIndexer();
  }}><strong>Total Delegated GRT Por Indexers Contar</strong></button>
  <hr></hr><button className="chatbot-button" onClick={this.handleButtonMenu}><strong>Menú Categorías</strong></button></a>
    ,
  );
  this.setState((prev) => ({
...
handleButtonSubgraph() { 
  ...
  const message = this.createChatbotMessage(<a><button className="chatbot-button" onClick={() => {
    ...
    this.handleSunsettingHostedService();
    this.handleButtonSubgraph();
  }}><strong>Servicio alojado de extinción</strong></button><br class="no-show-monitor"></br><button className="chatbot-button" onClick={() => {
    this.handleDecentralisedData();
    this.handleButtonSubgraph();
  }}><strong>Datos descentralizados</strong></button><br class="no-show-monitor"></br><button className="chatbot-button" onClick={() => {
  ...
  <button className="chatbot-button" onClick={() => {
    ...
    this.handleButtonSubgraph();
  }}><strong>Query usando Python</strong></button><br class="no-show-monitor"></br><button className="chatbot-button" onClick={() => {
    this.handleMessari();
    this.handleButtonSubgraph();
    ...
    this.handleButtonSubgraph();
  }}><strong>Subgraphs Contar</strong></button><br class="no-show-monitor"></br><button className="chatbot-button" onClick={() => {
    this.handleGitHub();
    this.handleButtonSubgraph();
...
handleButtonStatistics() { 
  ...
  const message = this.createChatbotMessage(<a><button className="chatbot-button" onClick={() => {
    ...
    this.handleButtonStatistics();
  }}><strong>Holders Contar</strong></button><br class="no-show-monitor"></br><button className="chatbot-button" onClick={() => {
    this.handleActiveDelegatorCount();
    this.handleButtonStatistics();
  }}><strong>Active Delegator Contar</strong></button><br class="no-show-monitor"></br><button className="chatbot-button" onClick={() => {
    this.handleActiveIndexerCount();
    ...
    this.handleButtonStatistics();
  }}><strong>Query Derechos</strong></button><br class="no-show-monitor"></br><button className="chatbot-button" onClick={() => {
    this.handleSubgraphsCount();
    this.handleButtonStatistics();
  }}><strong>Subgraphs Contar</strong></button><br class="no-show-monitor"></br><button className="chatbot-button" onClick={() => {
    this.handleTotalGRTDelegatedByDelegators();
    this.handleButtonStatistics();
  }}><strong>Total GRT Delegated Por Delegators</strong></button><br class="no-show-monitor"></br><button className="chatbot-button" onClick={() => {
    this.handleTotalDelegatedGRTByIndexersCount();
    this.handleButtonStatistics();
  }}><strong>Total GRT Delegated Por Indexers</strong></button><br class="no-show-monitor"></br><button className="chatbot-button" onClick={() => {
    this.handleTotalGRTSignalledByCurators();
    this.handleButtonStatistics();
  }}><strong>Total GRT Signalled Por Curators</strong></button><br class="no-show-monitor"></br><button className="chatbot-button" onClick={() => {
    this.handleTotalStakedGRTCount();
    this.handleButtonStatistics();
  }}><strong>Total Staked GRT Contar</strong></button><br class="no-show-monitor"></br><button className="chatbot-button" onClick={() => {
    this.handleTotalGRTBurnedCount();
    this.handleButtonStatistics();
  }}><strong>Total GRT Burned Contar</strong></button><hr></hr><button className="chatbot-button" onClick={this.handleButtonMenu}><strong>Menú Categorías</strong></button></a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleButtonNews() {
  this.handleButtonMenu = this.handleButtonMenu.bind(this);
  const message = this.createChatbotMessage(<a>Si desea mantenerse al día con las últimas noticias sobre The Graph, nuevos anuncios de asociación y leer sobre lo que está sucediendo dentro de la comunidad, los enlaces a continuación pueden ayudarlo con eso.<br></br><br></br><a className="cla" href="https://thegraph.com/blog/" target="_blank" rel="noreferrer">The Graph Blog</a><br></br><br></br><a className="cla" href="/GraphAdvocatesSpotlight" target="_blank" rel="noreferrer">Graph Advocates Spotlight</a><br></br><br></br>Asegúrate de seguir también a The Graph en <a className="cla" href="https://twitter.com/graphprotocol" target="_blank" rel="noreferrer">Twitter</a>.<hr></hr><button className="chatbot-button" onClick={this.handleButtonMenu}><strong>Menú Categorías</strong></button></a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleButtonLearnWeb3() { 
  ...
  const message = this.createChatbotMessage(<a><button className="chatbot-button" onClick={() => {
  ...
  }}><strong>¿Qué es la Red?</strong></button><br class="no-show-monitor"></br><button className="chatbot-button" onClick={() => {
    this.handleCourses();
    this.handleButtonLearnWeb3();
  }}><strong>Cursos</strong></button><br class="no-show-monitor"></br><button className="chatbot-button" onClick={() => {
    this.handleLearnWeb3();
    this.handleButtonLearnWeb3();
  }}><strong>Aprender Web3</strong></button><br class="no-show-monitor"></br><button className="chatbot-button" onClick={() => {
    ...
    this.handleEthereum();
    this.handleButtonLearnWeb3();
  }}><strong>Coin O Token</strong></button><br class="no-show-monitor"></br><button className="chatbot-button" onClick={() => {
    this.handleMining();
    this.handleButtonLearnWeb3();
    ...
    this.handleLayerTwo();
    this.handleButtonLearnWeb3();
  }}><strong>Layer Dos</strong></button><br class="no-show-monitor"></br><button className="chatbot-button" onClick={() => {
    this.handleTokenEconomics();
    this.handleButtonLearnWeb3();
  }}><strong>Token Económicas</strong></button><br class="no-show-monitor"></br><button className="chatbot-button" onClick={() => {
    this.handleTokenBurn();
    this.handleButtonLearnWeb3();
  }}><strong>Token Quemar</strong></button><br class="no-show-monitor"></br><button className="chatbot-button" onClick={() => {
    this.handleButtonCoreDevs();
    this.handleButtonLearnWeb3();

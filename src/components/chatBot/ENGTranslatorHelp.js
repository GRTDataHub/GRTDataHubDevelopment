  ...
  render(){
      return (
        ...
        <h3 className="QB-about-page-subtitle">How do I help with improvements and translating in the future?</h3>
              <h3 className="QB-about-page-text">You can visit the open-source GitHub page for the GRTDataHub, <a className="graphiql-link" href="https://github.com/GRTDataHub/GRTDataHubDevelopment/pulls" target="_blank" rel="noreferrer">here</a>. Pull requests help you collaborate on code with other people. As pull requests are created, they’ll appear here in a searchable and filterable list.</h3>
              <h3 className="QB-about-page-text">You can also message me directly via <a className="graphiql-link"  href="https://t.me/GRTDataHub" target="_blank" rel="noreferrer">Telegram</a>, <a className="graphiql-link"  href="https://twitter.com/GRTCrypto" target="_blank" rel="noreferrer">Twitter</a> or email admin@GRTDataHub.com. Another option is to use the Chatbot improvements form at the bottom of every chatbot.</h3>
        </div>
</div>

...
<br></br><br></br>
میٹا ماسک کے سوفٹ والیٹ کے بجائے ، آپ اپنے جی آر ٹی کو تفویض کرنے کے لئے ہارڈ والیٹ ، جیسے لیزر بھی استعمال کرسکتے ہیں۔ ہارڈ والیٹ سیکیورٹی کی ایک اور پرت شامل کرسکتے ہیں ، کیونکہ انہیں عام طور پر جسمانی آلے سے لین دین کی تصدیق کی ضرورت ہوتی ہے۔ آپ میٹا ماسک براؤزر ایکسٹینشن  کے ذریعہ میٹا ماسک کو اپنے ہارڈ ویئر والیٹ  سے مربوط  کرسکتے ہیں۔ اس بات کو یقینی بنائیں کہ آپ کے لیجر ڈیوائس پر ایتھریم ایپ کھلی ہے اور آپ کو اپنے آلے کے ایتھریم ایپ کے اندر کنٹریکٹ ڈیٹا کی اجازت ہے۔
<br></br><br></br>
...
handleCuratorTools() {
  ...
  <hr></hr>
  سب گراف کی اشاریہ سازی کی حیثیت کی جانچ <a className="cla" href="https://okgraph.xyz/" target="_blank" rel="noreferrer">پڑتال کریں</a><br></br><br></br>
  آپ یہاں سے ڈیٹا دیکھ سکتے ہیں:
  <br></br>مین نیٹ مشاورت کی شرح (روزانہ)<br></br>مین نیٹ مشاورت کی شرح (روزانہ)<br></br>مین نیٹ طلب فیس (ماہانہ، 30 دن کی حرکت پذیری اوسط)<br></br>نئے سب گراف (ماہانہ)<br></br>کل سب گراف<br></br>اوسط سب گراف کی شرح (ماہانہ، 30 دن کی حرکت پذیری اوسط)<br></br>سب راف مشاورت کی فیس (30 دن)<br></br>طلب کی شرح / سگنل کی شرح (30 دن)<br></br>سب گراف مشاورت کی فیس (30 دن) - ٪<br></br>
...
handleHostedService() {
  const message = this.createChatbotMessage(<a>ہوسٹڈ سروس گراف کو حاصل کرنے میں اہم کردار ادا کرتی رہی ہے جہاں یہ آج ہے، لیکن نقطہ نظر ہمیشہ ایک مہذب انڈیکسنگ پروٹوکول اور عالمی اے پی آئی بنانے کے لئے رہا ہے. جب گراف نیٹ ورک زندہ ہوجاتا ہے تو ، ڈویلپرز کے پاس آخر کار واقعی سرور لیس ڈیسنٹرلائزڈ ایپلیکیشنز فراہم کرنے کی صلاحیت ہوگی جو لوڈ کرنے میں تیز اور قابل اعتماد ہیں۔ مرکزی انفراسٹرکچر کی ضرورت نہیں ہوگی کیونکہ ایپلی کیشنز سوالات پر کارروائی کرنے کے لئے انڈیکسرز کے موثر نیٹ ورک سے براہ راست رابطہ قائم کرسکتی ہیں۔<br></br><br></br>ایتھریم سب گراف, گراف کے مہذب نیٹ ورک میں منتقل ہونا جاری رکھے ہوئے ہیں۔ جیسا کہ ویب 3 اپنانے میں اضافہ ہوتا ہے، اسی طرح پیمانے اور کارکردگی کی مانگ بھی بڑھتی ہے. ڈویلپرز کو ایک اہم انتخاب کا سامنا کرنا پڑتا ہے: مرکزی ٹکنالوجی پر انحصار جاری رکھیں یا مہذب بنیادی ڈھانچے پر سوئچ کریں۔<br></br>لمبی عمر اور وشوسنییتا کے لئے ، کچھ بھی غیر مرکزیت کو شکست نہیں دیتا ہے۔ ناکامی کے مرکزی نکات سے گریز کرکے ، آپ اپنے صارفین کو ایک ویب 3 ایپلی کیشن پیش کررہے ہیں جس تک وہ مستقل طور پر رسائی حاصل کرسکتے ہیں۔ بہت سے منصوبوں نے پہلے ہی پیداوار میں نیٹ ورک کی توثیق کی ہے اور اب آپ کے منصوبے کو منتقل کرنے کا بہترین وقت ہے.<br></br><br></br>
  <br></br>
  اگر آپ کسی ذیلی گراف کو میزبان سروس سے مین نیٹ پر منتقل کرنے کے بارے میں مرحلہ وار گائیڈ تلاش کر رہے ہیں، تو <a className="cla" href="https://codex.thegraph.com/repositories-and-documentation/official-documentation/hosted-service/migrating-subgraph" target="_blank" rel="noreferrer">یہاں</a> دیکھیں۔
...
handleFireHose() {
  ...
  <hr></hr>ان کے بارے میں مزید جاننے کے لئے مجھ سے اسٹریمنگ فاسٹ کے بارے میں پوچھیں۔</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleGraphDay() {
  ...
  پورے واقعہ کے بارے میں مزید جاننے کے لئے <a className="cla" href="https://thegraph.com/graph-day/2022/" target="_blank" rel="noreferrer">گراف دن</a> اور <a className="cla" href="https://thegraph.com/graph-hack/2022/" target="_blank" rel="noreferrer">گراف ہیک</a> ملاحظہ کریں.<hr></hr>
...
handleWhatIsABlockchain() {
  const message = this.createChatbotMessage(<a>بلاکچین کو ایک لیجر کے طور پر سوچا جاسکتا ہے جو کرپٹو کرنسی کے لین دین کو اسی طرح ٹریک کرنے کے لئے استعمال ہوتا ہے جس طرح چیک بک کے اخراجات کو چیک بک ریکارڈ کے ساتھ ٹریک کیا جاتا ہے۔ بلاکچین کرپٹو کرنسیوں ، جیسے ایتھریم یا بٹ کوائن کے ساتھ کیے گئے لین دین کو ریکارڈ کرنے کا ایک نظام ہے۔ ٹرانزیکشن ڈیٹا بہت سے ٹرانزیکشنز کے بلاک میں ذخیرہ کیا جاتا ہے. ایک بار جب بلاک بھر جاتا ہے تو ، ایک نیا بلاک تشکیل دیا جاتا ہے جو پچھلے بلاک اور چینز کو پچھلے بلاک میں حوالہ دیتا ہے۔ لہذا بلاکچین کی اصطلاح.<br></br><br></br>کچھ بلاکچینز ، جیسے ایتھریم ، کو پیر ٹو پیر کمپیوٹر نیٹ ورک کا استعمال کرتے ہوئے برقرار رکھا جاتا ہے ، جس سے کسی بھی صارف کو دنیا میں کہیں سے بھی بلاکچین کی میزبانی اور رسائی حاصل کرنے کی اجازت ملتی ہے۔ جیسے جیسے کوئی لین دین ہوتا ہے ، اسے بلاکچین نیٹ ورک پر ہر صارف کے لیجر میں ریکارڈ اور تقسیم کیا جاتا ہے۔<br></br><br></br>یہ انفرادی کمپیوٹرز ، جب ایک ساتھ استعمال ہوتے ہیں تو ، تمام بلاکچین ڈیٹا کو اسٹور کرنے کے لئے ایک مہذب عالمی ڈیٹا بیس تشکیل دیتے ہیں۔ ڈیسنٹرلائزڈ کا مطلب یہ ہے کہ ڈیٹا کو ایک جگہ پر منظم کرنے اور کسی ایک کمپنی یا شخص کے ذریعہ کنٹرول کرنے کے بجائے ، نیٹ ورک کا استعمال کرنے والا ہر شخص اس کا انتظام کرتا ہے۔<br></br><br></br>بلاکچینز کو ناقابل تغیر ہونے کے لئے ڈیزائن کیا گیا ہے ، یعنی ، ناقابل تغیر۔ ایک بار جب بلاکچین پر کچھ ریکارڈ کیا گیا ہے تو ، اسے تبدیل یا الٹا نہیں کیا جاسکتا ہے۔ اس کا مطلب یہ ہے کہ بلاکچین پر کوئی بھی ٹرانزیکشن مستقل ہے اور کسی کو بھی دیکھنے کے لئے ہمیشہ ایک ریکارڈ دستیاب ہوگا. بلاکچین کے اعداد و شمار کے ڈھانچے کے ساتھ مل کر غیر مرکزیت واقعات کی مستقل ٹائم لائن بناتی ہے۔<br></br><br></br>کچھ بینکوں کو آپ کو ان ٹرانزیکشنز کو دیکھنے کے لئے ان سے رابطہ کرنے کی ضرورت ہوتی ہے جو آپ کے اکاؤنٹ میں ایک ماہ سے زیادہ ہے. بلاکچین کا استعمال آپ کے بینک سے رابطہ کرنے کی ضرورت کو ختم کردے گا کیونکہ آپ کے تمام لین دین آپ کو دیکھنے کے لئے پہلے سے ہی دستیاب ہوں گے.</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleEthereum() {
  const message = this.createChatbotMessage(<a>ایتھریم ایک قابل پروگرام بلاکچین ٹیکنالوجی ہے جسے 2013 میں شروع ہونے والی وٹالک بوٹیرن نے تیار کیا  تھا۔ ایتھریم صارفین کو کرپٹو کرنسیوں کو بھیجنے اور وصول کرنے ، ڈیپس کے نام سے مشہور مہذب ایپلیکیشنز تک رسائی حاصل کرنے اور تخلیق کرنے ، اسٹیکنگ کے ذریعہ انعامات کمانے ، اور بہت کچھ کرنے کی اجازت دیتا ہے۔ مالیاتی خدمات تک مفت رسائی اور زیادہ نجی اور مہذب انٹرنیٹ ایتھروم فاؤنڈیشن کے کچھ اہم اہداف ہیں۔<br></br><br></br>اس کے تصور کے بعد ، ایتھریم نے کنٹرول میں کسی ایک شخص کے بغیر ایک مہذب حکمرانی کا نظام نافذ کیا۔ ملکیت کی یہ کمی حکومتوں یا تنظیموں کے لئے آپ کو ایتھریم پر خدمات تک رسائی سے انکار کرنا تقریبا ناممکن بنا دیتی ہے۔ ایتھریم پر ایپلیکیشنز کو ان کو استعمال کرنے کے لئے آپ کے تمام ذاتی ڈیٹا کی ضرورت نہیں ہے. یہ صارفین کو ان کی رازداری پر زیادہ کنٹرول دیتا ہے اور انہیں ہر ٹرانزیکشن میں محفوظ رکھتا ہے.<br></br><br></br>ایتھریم کسی کے لئے بھی کھلا ہے ، کہیں بھی ، جب تک کہ انہیں ایتھریم والیٹ تک رسائی حاصل ہو ، جیسے لوپرنگ اسمارٹ والیٹ۔ آپ ایتھریم والیٹ کو بینکنگ ایپ کے طور پر سوچ سکتے ہیں ، بغیر کسی بینک کے آپ کے فنڈز کو کنٹرول کیے۔ صرف ایک انٹرنیٹ کنکشن کے ساتھ، ایتھروم ہر ایک کو استعمال کرنے کے لئے دستیاب ہے، دنیا بھر میں بینکنگ کی خدمات تک رسائی فراہم کرتا ہے.<br></br><br></br>ایتھریم بلاکچین پر تمام ٹرانزیکشنز مقامی کرپٹو کرنسی ایتھر یا ایتھریم کی طرف سے طاقتور ہیں. ہر بار جب ایتھریم بھیجا جاتا ہے یا ڈیپ استعمال کیا جاتا ہے تو ، صارفین ایتھریم نیٹ ورک استعمال کرنے کے لئے ایتھریم میں ایک چھوٹی سی فیس ادا کرتے ہیں۔ یہ فیس بلاکچین پر کارروائیوں کی تصدیق کرنے کے لئے کان کنوں کو انعام دینے میں مدد کرنے کے لئے استعمال کیا جاتا ہے. کان کن اس بات کو یقینی بنانے کے لئے رکھوالوں کے طور پر کام کرتے ہیں کہ کوئی بھی بلاکچین کے ساتھ دھوکہ دہی یا چھیڑ چھاڑ نہیں کررہا ہے اور اسے محفوظ رکھتا ہے۔ یہ کام کے ثبوت کے طور پر جانا جاتا ہے. ایتھریم کا مستقبل بلاکچین کی حفاظت کا ایک نیا طریقہ لاتا ہے جس میں صارفین کو بلاکچین ریکارڈز کے محافظوں کے طور پر کام کرنے کی اجازت دینے کے لئے فنڈز کا وعدہ کیا جاتا ہے یا جمع کیا جاتا ہے. یہ داؤ کے ثبوت کے طور پر جانا جاتا ہے.</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
<tr className="indexer-table">
  ...
  <td>اسکیل:  ایتھریم یا بٹ کوائن ڈاٹ کے سائز تک پہنچنے کے لئے اب بھی پی او ایس سسٹم ہونا ضروری ہے</td>
</tr>
<br></br><br></br>
<tr className="indexer-table">
  <td>کارکردگی: آپ کو پیچیدہ کمپیوٹر کے مسائل کو حل کرنے کی ضرورت نہیں ہے، لہذا آپ لین دین کی رفتار میں اضافہ کرتے ہیں</td>
...
handleCoinOrToken() {
  const message = this.createChatbotMessage(<a><strong>سکہ</strong><br></br>کرپٹو کرنسی میں ، "کرنسی" کی اصطلاح ایک ایسی کرنسی کی وضاحت کرنے کے لئے استعمال کی جاتی ہے جو اس کے اپنے بلاکچین (مثال کے طور پر ، ایتھر برائے ایتھریم بلاکچین ، بٹ کوائن بلاکچین کے لئے بٹ کوائن ، وغیرہ) سے تعلق رکھتی ہے۔ کرنسی ایک ڈیجیٹل کرنسی ہے جسے کئی طریقوں سے استعمال کیا جاسکتا ہے:<br></br>ادائیگی کی ایک شکل کے طور پر (مثال کے طور پر ، کسی شے یا خدمت کے لئے ایتھریم کو کسی دوسرے میں منتقل کرنا) ، قدر کا ذخیرہ (مثال کے طور پر ، کچھ بٹ کوائن کو کسی کی دولت کے لئے "محفوظ پناہ گاہ" کے طور پر دیکھتے ہیں) ، اکاؤنٹ کی اکائی (مثال کے طور پر ، این ایف ٹی جیسی اشیاء کی قیمت ایتھریم میں ہوسکتی ہے) ، اور بلاکچینز کے لئے جو کام کا ثبوت استعمال کرتے ہیں ، مقامی کرنسی پروسیسنگ ٹرانزیکشنز اور بلاکس تیار کرنے کے لئے کان کنوں کو ادائیگی کرنے کے لئے بھی استعمال ہوتی ہے۔<br></br><br></br><strong>استعاری</strong><br></br>اگرچہ ایک سکہ اس کے اپنے بلاکچین کا مقامی ہے ، لیکن موجودہ بلاکچین پر ایک ٹوکن تیار کیا جاتا ہے۔ ٹوکن کے لئے ہر بلاکچین کی اپنی شکل ہوتی ہے۔ مثال کے طور پر ، ایتھریم بلاکچین پر بنائے گئے ٹوکنوں میں سابقہ ای آر سی ہوتا ہے جس کے بعد ایک نمبر ہوتا ہے (جیسے ای آر سی 20)۔ تکنیکی طور پر ، کوئی بھی ٹوکن تشکیل دے سکتا ہے ، لہذا  خریدنے سے پہلے ہمیشہ ٹوکینومکس کی تحقیق اور پڑھنے کی سفارش کی جاتی ہے۔<br></br>آپ جو معیاری استعمال کرتے ہیں اس پر انحصار کرتے ہوئے ایک ٹوکن فنگبل (قابل تبادلہ) یا غیر فنگبل ہوسکتا ہے۔ ایتھریم پر ، معیاری ٹوکن کی کچھ مثالیں یہ ہیں:<br></br><br></br>ای آر سی-20<br></br>ای آر سی-20<br></br><br></br>ای آر سی-721<br></br>غیر فنجبل ٹوکن کے لئے استعمال ہونے والا معیاری ، جیسے آرٹ یا گانے کے کام کے لئے این ایف ٹی۔<br></br><br></br>ای آر سی-1155<br></br>معیاری جو زیادہ موثر آپریشنز اور ٹرانزیکشنز کی گروپبندی کی اجازت دیتا ہے۔ یہ کسی بھی تعداد میں فنجبل اور غیر فنجبل ٹوکن اقسام کی نمائندگی اور کنٹرول کرسکتا ہے۔ یعنی ، ای آر سی -1155 ٹوکن ای آر سی -20 اور ای آر سی -721 ٹوکن کی طرح ایک ہی کام انجام دے سکتا ہے ، اور یہاں تک کہ دونوں ایک ہی وقت میں۔</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleLayerTwo() {
  const message = this.createChatbotMessage(<a>پرت 2 (ایل 2) ایک ثانوی فریم ورک یا پروٹوکول سے مراد ہے جو موجودہ بلاکچین پر بناتا ہے۔ ایل 2 پروٹوکول کا بنیادی مقصد ٹرانزیکشن کی رفتار اور بڑے کرپٹو کرنسی نیٹ ورکس کی اسکیلنگ کی مشکلات کو حل کرنے میں مدد کرنا ہے ، ایتھریم کے لئے ہم اسے ایتھریم اسکیلنگ ٹریلیما کہتے ہیں: اسکیلنگ ، اسپیڈ ، اور ڈیسنٹرلائزیشن۔<br></br><br></br>ایتھریم فی الحال فی سیکنڈ ~ 13 ٹرانزیکشنز پر عملدرآمد کرتا ہے، جبکہ ماسٹر کارڈ اور ویزا جیسے کریڈٹ کارڈ کمپنیاں 1700 ٹی پی ایس پر عملدرآمد کرتی ہیں اور ایک چھوٹی سی فیس وصول کرتی ہیں. اگر آپ چھوٹے کاروباری اداروں کے لئے اسکوائر یا اسی طرح کی خدمات سے واقف ہیں تو ، آپ کبھی بھی لین دین کے لئے اکیلے ایتھریم کا استعمال کرنے کا تصور نہیں کریں گے۔ ادائیگی کی توثیق کرنے کے لئے 20 سے 30 منٹ تک ادائیگی کرنے کی کوشش کرنے اور انتظار کرنے کا تصور کریں ، اس توثیق کے لئے گیس کی فیس ادا کرنے کا ذکر نہ کریں۔ یہی وہ جگہ ہے جہاں ایل 2 آتا ہے اور ایسا کرنے کے کچھ طریقے ہیں۔<br></br><br></br>یہ تیز ، سستا ، اور ایتھریم کی طرح ہی محفوظ ہے۔ ہر کوئی ایسا کیوں نہیں کرتا؟ ٹھیک ہے، پرامید رول اپ طویل تکمیل / واپسی کے اوقات سے دوچار ہیں، عام طور پر 7 دن کے لئے فنڈز رکھتے ہیں. ویلیڈیم اور پلازما آف چین ہیں اور اس وجہ سے ایتھریم کی حقیقی حفاظت کی کمی ہے.  زکرولاپ تمام دنیاؤں میں سب سے بہترین ہیں کیونکہ وہ چین میں تیز اور محفوظ ہیں ، لیکن ان کی ترقی کے لئے درکار ٹکنالوجی بہت مشکل ہے۔</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,
...
handleSmartContract() {
  const message = this.createChatbotMessage(<a>ایک "سمارٹ کنٹریکٹ" صرف ایک پروگرام ہے جو ایتھریم بلاکچین پر چلتا ہے. یہ کوڈ اور اعداد و شمار کا ایک مجموعہ ہے جو بلاکچین پر ایک مخصوص پتے پر رہتا ہے۔ ایتھریم اکاؤنٹ کی ایک قسم ہے. وہ توازن برقرار رکھ سکتے ہیں اور نیٹ ورک پر لین دین بھیج سکتے ہیں ، لیکن وہ صارف کے ذریعہ کنٹرول نہیں کیے جاتے ہیں۔ انہیں بالکل وہی کرنے کے لئے پروگرام کیا جاتا ہے جو انہیں بتایا جاتا ہے ، قواعد کی وضاحت کرتے ہیں اور ان کے کوڈ کی بنیاد پر خود بخود ان کا اطلاق کرتے ہیں۔</a>
    ,
  );
  this.setState((prev) => ({
    ...prev,

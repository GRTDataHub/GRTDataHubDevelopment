...
require('highcharts/modules/export-data')(Highcharts);
  ...
  const options = useColumnGraphOptionsBuilder(
    ...
    tickInterval : ([data?.activeDelegatorCount?.Amount28D+data?.activeDelegatorCount?.Amount7D+data?.activeDelegatorCount?.AmountNow]/50),
    min: [([data?.activeDelegatorCount?.Amount28D+data?.activeDelegatorCount?.Amount7D+data?.activeDelegatorCount?.AmountNow]/3)*0.85],
...
export function AdminHoldersCountBar(){
  ...
  const options = useColumnGraphOptionsBuilder(
    ...
    tickInterval : ([data?.holdersCount?.Amount28D+data?.holdersCount?.Amount7D+data?.holdersCount?.AmountNow]/50),
    min: [([data?.holdersCount?.Amount28D+data?.holdersCount?.Amount7D+data?.holdersCount?.AmountNow]/3)*0.88],
...
export function AdminCuratorCountBar(){
  ...
  const options = useColumnGraphOptionsBuilder(
    ...
    tickInterval : ([data?.curatorCount?.Amount28D+data?.curatorCount?.Amount7D+data?.curatorCount?.AmountNow]/80),
    min: [([data?.curatorCount?.Amount28D+data?.curatorCount?.Amount7D+data?.curatorCount?.AmountNow]/3)*0.93],
    dataLabelFontSize: '3.5vh',
    dataLabelX: 10,
    subtitleX: 0,
    subtitleY: 25,
...
export function AdminActiveDelegationCountBar(){
  ...
  const options = useColumnGraphOptionsBuilder(
    ...
    tickInterval : ([data?.activeDelegationCount?.Amount28D+data?.activeDelegationCount?.Amount7D+data?.activeDelegationCount?.AmountNow]/50),
    min: [([data?.activeDelegationCount?.Amount28D+data?.activeDelegationCount?.Amount7D+data?.activeDelegationCount?.AmountNow]/3)*0.85],
    dataLabelFontSize: '3.5vh',
    dataLabelX: 15,
    subtitleX: 0,
    subtitleY: 25,
...
export function AdminActiveIndexersCountBar(){
  ...
  const options = useColumnGraphOptionsBuilder(
    ...
    tickInterval : ([data?.activeIndexersCount?.Amount28D+data?.activeIndexersCount?.Amount7D+data?.activeIndexersCount?.AmountNow]/50),
    min: [([data?.activeIndexersCount?.Amount28D+data?.activeIndexersCount?.Amount7D+data?.activeIndexersCount?.AmountNow]/3)*0.80],
    dataLabelFontSize: '3.5vh',
    dataLabelX: 10,
    subtitleX: 0,
    subtitleY: 25,
...
export function AdminTotalDelegatedGRT(){
  ...
  const options = useColumnGraphOptionsBuilder(
    ...
    tickInterval : ([data?.totalDelegatedTokens?.Amount28D+data?.totalDelegatedTokens?.Amount7D+data?.totalDelegatedTokens?.AmountNow]/100),
    min: [([data?.totalDelegatedTokens?.Amount28D+data?.totalDelegatedTokens?.Amount7D+data?.totalDelegatedTokens?.AmountNow]/3)*0.93],
...
export function AdminTotalDelegatedGRTIndexers(){
  ...
  const options = useColumnGraphOptionsBuilder(
    ...
    tickInterval : ([data?.totalTokensStaked?.Amount28D+data?.totalTokensStaked?.Amount7D+data?.totalTokensStaked?.AmountNow]/100),
    min: [([data?.totalTokensStaked?.Amount28D+data?.totalTokensStaked?.Amount7D+data?.totalTokensStaked?.AmountNow]/3)*0.9],
    dataLabelFontSize: '2.75vh',
    dataLabelX: 30,
    subtitleX: 0,
    subtitleY: 25,
...
export function AdminTotalQueryFees(){
  ...
  const options = useColumnGraphOptionsBuilder(
    ...
    tickInterval : ([data?.totalQueryFees?.Amount28D+data?.totalQueryFees?.Amount7D+data?.totalQueryFees?.AmountNow]/20),
    min: [([data?.totalQueryFees?.Amount28D+data?.totalQueryFees?.Amount7D+data?.totalQueryFees?.AmountNow]/3)*0.50],
    dataLabelFontSize: '3.5vh',
    dataLabelX: 20,
    subtitleX: 0,
    subtitleY: 25,
...
export function AdminTotalTokensSignalled(){
  ...
  const options = useColumnGraphOptionsBuilder(
    ...
    tickInterval : ([data?.totalTokensSignalled?.Amount28D+data?.totalTokensSignalled?.Amount7D+data?.totalTokensSignalled?.AmountNow]/20),
    min: [([data?.totalTokensSignalled?.Amount28D+data?.totalTokensSignalled?.Amount7D+data?.totalTokensSignalled?.AmountNow]/3)*0.70],
    dataLabelFontSize: '3.5vh',
    dataLabelX: 25,
    subtitleX: 0,
    subtitleY: 25,
...
export function AdminTotalStakedGRT(){
  ...
  const options = useColumnGraphOptionsBuilder(
    ...
    tickInterval : ([data?.totalTokensAllocated?.Amount28D+data?.totalTokensAllocated?.Amount7D+data?.totalTokensAllocated?.AmountNow]/50),
    min: [([data?.totalTokensAllocated?.Amount28D+data?.totalTokensAllocated?.Amount7D+data?.totalTokensAllocated?.AmountNow]/3)*0.85],
    dataLabelFontSize: '2.75vh',
    dataLabelX: 30,
    subtitleX: 0,
   subtitleY: 25,
...
export function AdminTotalBurnedGRT(){
  ...
  const options = useColumnGraphOptionsBuilder(
    ...
    tickInterval : ([data?.totalGRTBurned?.Amount28D+data?.totalGRTBurned?.Amount7D+data?.totalGRTBurned?.AmountNow]/100),
    min: [([data?.totalGRTBurned?.Amount28D+data?.totalGRTBurned?.Amount7D+data?.totalGRTBurned?.AmountNow]/3)*0.94],
    dataLabelFontSize: '2.75vh',
    dataLabelX: 20,
    subtitleX: 0,
   subtitleY: 25,
...
export function MobileAdminTotalQueryFees(){
  ...
  const options = useColumnGraphOptionsBuilder(
    ...
    data : [data?.totalQueryFees?.Amount28D, data?.totalQueryFees?.Amount7D, data?.totalQueryFees?.AmountNow],
    tickInterval : ([data?.totalQueryFees?.Amount28D+data?.totalQueryFees?.Amount7D+data?.totalQueryFees?.AmountNow]/20),
    min: [([data?.totalQueryFees?.Amount28D+data?.totalQueryFees?.Amount7D+data?.totalQueryFees?.AmountNow]/3)*0.40],
    dataLabelFontSize: '5vh',
    dataLabelX: 0,
    subtitleX: 0,
    subtitleY: 20,
...
export function MobileAdminTotalTokensSignalled(){
  ...
  const options = useColumnGraphOptionsBuilder(
    ...
    data : [data?.totalTokensSignalled?.Amount28D, data?.totalTokensSignalled?.Amount7D, data?.totalTokensSignalled?.AmountNow],
    tickInterval : ([data?.totalTokensSignalled?.Amount28D+data?.totalTokensSignalled?.Amount7D+data?.totalTokensSignalled?.AmountNow]/20),
    min: [([data?.totalTokensSignalled?.Amount28D+data?.totalTokensSignalled?.Amount7D+data?.totalTokensSignalled?.AmountNow]/3)*0.60],
    dataLabelFontSize: '5vh',
    dataLabelX: 0,
    subtitleX: 0,
    subtitleY: 20,

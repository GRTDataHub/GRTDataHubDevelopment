...
function NewMobileTotalUnclaimedQueryFeeRebatesBarChartsData() {
...
require('highcharts/modules/export-data')(Highcharts);
    ...
    const fetchDataNow = async () => {
      try {        
        const queryParams = {
          ...
          body : 'totalUnclaimedQueryFeeRebates'
        };
        ...
        setDataNow(res.data.data.graphNetworkDailyDatas[0].totalUnclaimedQueryFeeRebates/1000000000000000000);
      } catch (error) {
        console.error(error);
      }
    };
  ...
  useEffect(() => {
    const fetchData7Days = async () => {
      try {        
        ...
        setData7Days(res.data.data.graphNetworkDailyDatas[6].totalUnclaimedQueryFeeRebates/1000000000000000000);
      } catch (error) {
        console.error(error);
      }
    };
  ...
  useEffect(() => {
    const fetchData28Days = async () => {
      try {        
        ...
        setData28Days(res.data.data.graphNetworkDailyDatas[27].totalUnclaimedQueryFeeRebates/1000000000000000000);
      } catch (error) {
        console.error(error);
      }
    };
  ...
  const options = {
    ...
    title: {style: {
      ...
      text : 'Total Unclaimed Query Fee Rebates',
      align: 'center',
      y: 20,
    },
    subtitle: {
    ...
    [
      {formatter: function() {
        return Highcharts.dateFormat('%d %b %Y',this.value);
      },  name: 'Total Unclaimed Query Fee Rebates',
      color: {
...
export default NewMobileTotalUnclaimedQueryFeeRebatesBarChartsData;

...
function NewMobileTotalIndexingDelegatorRewardsBarChartsData() {
...
require('highcharts/modules/export-data')(Highcharts);
    ...
    const fetchDataNow = async () => {
      try {        
        const queryParams = {
          ...
          body : 'totalIndexingDelegatorRewards'
        };
        ...
        setDataNow(res.data.data.graphNetworkDailyDatas[0].totalIndexingDelegatorRewards/1000000000000000000);
      } catch (error) {
        console.error(error);
      }
    };
  ...
  useEffect(() => {
    const fetchData7Days = async () => {
      try {        
        ...
        setData7Days(res.data.data.graphNetworkDailyDatas[6].totalIndexingDelegatorRewards/1000000000000000000);
      } catch (error) {
        console.error(error);
      }
    };
  ...
  useEffect(() => {
    const fetchData28Days = async () => {
      try {        
        ...
        setData28Days(res.data.data.graphNetworkDailyDatas[27].totalIndexingDelegatorRewards/1000000000000000000);
      } catch (error) {
        console.error(error);
      }
    };
  ...
  const options = {
    ...
    title: {style: {
      ...
      text : 'Total Indexing Delegator Rewards',
      align: 'center',
      y: 20,
    },
    subtitle: {
    ...
    [
      {formatter: function() {
        return Highcharts.dateFormat('%d %b %Y',this.value);
      },  name: 'Total Indexing Delegator Rewards',
      color: {
...
export default NewMobileTotalIndexingDelegatorRewardsBarChartsData;

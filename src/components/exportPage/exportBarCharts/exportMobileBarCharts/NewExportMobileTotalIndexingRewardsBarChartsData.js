...
function NewMobileTotalIndexingRewardsBarChartsData() {
  ...
  useEffect(() => {
    const fetchDataNow = async () => {
      try {        
        ...
        setDataNow(res.data.data.graphNetworkDailyDatas[0].totalIndexingRewards/1000000000000000000);
      } catch (error) {
        console.error(error);
      }
    };
  ...
  useEffect(() => {
    const fetchData7Days = async () => {
      try {        
        ...
        setData7Days(res.data.data.graphNetworkDailyDatas[6].totalIndexingRewards/1000000000000000000);
      } catch (error) {
        console.error(error);
      }
    };
  ...
  useEffect(() => {
    const fetchData28Days = async () => {
      try {        
        ...
        setData28Days(res.data.data.graphNetworkDailyDatas[27].totalIndexingRewards/1000000000000000000);
      } catch (error) {
        console.error(error);
      }
    };
...
export default NewMobileTotalIndexingRewardsBarChartsData;

...
function NewMobileTotalIndexingIndexerRewardsBarChartsData() {
...
require('highcharts/modules/export-data')(Highcharts);
    ...
    const fetchDataNow = async () => {
      try {        
        const queryParams = {
          ...
          body : 'totalIndexingIndexerRewards'
        };
        ...
        setDataNow(res.data.data.graphNetworkDailyDatas[0].totalIndexingIndexerRewards/1000000000000000000);
      } catch (error) {
        console.error(error);
      }
    };
  ...
  useEffect(() => {
    const fetchData7Days = async () => {
      try {        
        ...
        setData7Days(res.data.data.graphNetworkDailyDatas[6].totalIndexingIndexerRewards/1000000000000000000);
      } catch (error) {
        console.error(error);
      }
    };
  ...
  useEffect(() => {
    const fetchData28Days = async () => {
      try {        
        ...
        setData28Days(res.data.data.graphNetworkDailyDatas[27].totalIndexingIndexerRewards/1000000000000000000);
      } catch (error) {
        console.error(error);
      }
    };
  ...
  const options = {
    ...
    [
      {formatter: function() {
        return Highcharts.dateFormat('%d %b %Y',this.value);
      },  name: 'Total Indexing Indexer Rewards',
      color: {
...
export default NewMobileTotalIndexingIndexerRewardsBarChartsData;

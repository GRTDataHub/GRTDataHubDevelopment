...
function NewMobileTotalDelegatorQueryFeeRebatesBarChartsData() {
...
require('highcharts/modules/export-data')(Highcharts);
    ...
    const fetchDataNow = async () => {
      try {        
        const queryParams = {
          ...
          body : 'totalDelegatorQueryFeeRebates'
        };
        ...
        setDataNow(res.data.data.graphNetworkDailyDatas[0].totalDelegatorQueryFeeRebates/1000000000000000000);
      } catch (error) {
        console.error(error);
      }
    };
  ...
  useEffect(() => {
    const fetchData7Days = async () => {
      try {        
        ...
        setData7Days(res.data.data.graphNetworkDailyDatas[6].totalDelegatorQueryFeeRebates/1000000000000000000);
      } catch (error) {
        console.error(error);
      }
    };
  ...
  useEffect(() => {
    const fetchData28Days = async () => {
      try {        
        ...
        setData28Days(res.data.data.graphNetworkDailyDatas[27].totalDelegatorQueryFeeRebates/1000000000000000000);
      } catch (error) {
        console.error(error);
      }
    };
  ...
  const options = {
    ...
    title: {style: {
      ...
      text : 'Total Delegator Query Fee Rebates',
      align: 'center',
      y: 20,
    },
    subtitle: {
    ...
    [
      {formatter: function() {
        return Highcharts.dateFormat('%d %b %Y',this.value);
      },  name: 'Total Delegator Query Fee Rebates',
      color: {
...
export default NewMobileTotalDelegatorQueryFeeRebatesBarChartsData;

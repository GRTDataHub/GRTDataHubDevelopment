...
<div class="message">
  Please rotate your device to landscape to view export data.<br></br>
        ...
        <h1 className="adminHeader-text2 move-down mobile-config admin-mobile-center">1. Click Export Button<br></br>2. Download PNG Image<br></br>3. Select View<br></br>4. Press and Hold the screen with finger<br></br>5. Select Add to Photos / Save Image</h1>
        ...
        <h2 className="adminSubheader-text admin-subtitle-centre  monitor-config">3. Select View</h2>
